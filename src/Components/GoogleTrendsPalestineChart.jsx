...
class GoogleTrendsPalestineChart extends Component {
	...
	getGoogleTrendsPalestineDataPoints(date, word) {
		var dps = []
		var year = 2019
		var month = 1
		var day, value
    ...
    render() {
		const googleTrendsPalestine = {
			...
			data: [
			{
				...
				visible: false,
				showInLegend: true,
				dataPoints: this.getGoogleTrendsPalestineDataPoints(2019, "شهادة")
			},
			{
				type: "line",
				name: "استشهاد",
				visible: false,
				showInLegend: true,
				dataPoints: this.getGoogleTrendsPalestineDataPoints(2019, "استشهاد")
			},
			{
				type: "line",
				name: "شهيد",
				visible: false,
				showInLegend: true,
				dataPoints: this.getGoogleTrendsPalestineDataPoints(2019, "شهيد")
			},
			{
				type: "line",
				name: "جهاد",
				visible: false,
				showInLegend: true,
				dataPoints: this.getGoogleTrendsPalestineDataPoints(2019, "جهاد")
			},
			{
				type: "line",
				name: "كافر",
				visible: true,
				showInLegend: true,
				dataPoints: this.getGoogleTrendsPalestineDataPoints(2019, "كافر")
			}]
		}
