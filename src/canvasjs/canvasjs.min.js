...
case "DD":return X(V,2);case "DDD":return U[L];case "DDDD":return H[L];case "M":return W+1;case "MM":return X(W+1,2);case "MMM":return R[W];case "MMMM":return Q[W];case "Y":return parseInt(String(a).slice(-2));case "YY":return X(String(a).slice(-2),2);case "YYY":return X(String(a).slice(-3),3);case "YYYY":return X(a,4);case "h":return d%12||12;case "hh":return X(d%12||12,2);case "H":return d;case "HH":return X(d,2);case "m":return c;case "mm":return X(c,2);case "s":return b;case "ss":return X(b,2);
case "f":return X(String(e),3).slice(0,1);case "ff":return X(String(e),3).slice(0,2);case "fff":return X(String(e),3).slice(0,3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return J?"UTC":(String(F).match(y)||[""]).pop().replace(E,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+X(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+X(Math.floor(Math.abs(f)/60),2)+
X(Math.abs(f)%60,2);default:return l.slice(1,l.length-1)}})}}(),ea=function(h,m,w){if(null===h)return"";if(!isFinite(h))return h;h=Number(h);var s=0>h?!0:!1;s&&(h*=-1);var v=w?w.decimalSeparator:".",y=w?w.digitGroupSeparator:",",E="";m=String(m);var E=1,F=w="",O=-1,N=[],H=[],Q=0,J=0,U=0,R=!1,V=0,F=m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);m=null;for(var L=0;F&&L<F.length;L++)if(m=F[L],"."===m&&0>O)O=L;else{if("%"===m)E*=100;else if("\u2030"===m){E*=1E3;continue}else if(","===m[0]&&
"."===m[m.length-1]){E/=Math.pow(1E3,m.length-1);O=L+m.length-1;continue}else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||(R=!0);0>O?(N.push(m),"#"===m||"0"===m?Q++:","===m&&U++):(H.push(m),"#"!==m&&"0"!==m||J++)}R&&(m=Math.floor(h),F=-Math.floor(Math.log(h)/Math.LN10+1),V=0===h?0:0===m?-(Q+F):String(m).length-Q,E/=Math.pow(10,V));0>O&&(O=L);E=(h*E).toFixed(J);m=E.split(".");E=(m[0]+"").split("");h=(m[1]+"").split("");E&&"0"===E[0]&&E.shift();for(R=F=L=J=O=0;0<N.length;)if(m=N.pop(),"#"===m||"0"===
m)if(O++,O===Q){var W=E,E=[];if("0"===m)for(m=Q-J-(W?W.length:0);0<m;)W.unshift("0"),m--;for(;0<W.length;)w=W.pop()+w,R++,0===R%F&&(L===U&&0<W.length)&&(w=y+w)}else 0<E.length?(w=E.pop()+w,J++,R++):"0"===m&&(w="0"+w,J++,R++),0===R%F&&(L===U&&0<E.length)&&(w=y+w);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?","===m?(L++,F=R,R=0,0<E.length&&(w=y+w)):w=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+w:m+w:(m=0>V?m.replace("+",
"").replace("-",""):m.replace("-",""),w+=m.replace(/[0]+/,function(a){return X(V,a.length)}));y="";for(N=!1;0<H.length;)m=H.shift(),"#"===m||"0"===m?0<h.length&&0!==Number(h.join(""))?(y+=h.shift(),N=!0):"0"===m&&(y+="0",N=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?y+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?y+=m:(m=0>V?m.replace("+","").replace("-",""):m.replace("-",""),y+=m.replace(/[0]+/,function(a){return X(V,
a.length)}));w+=(N?v:"")+y;return s?"-"+w:w},La=function(h){var m=0,w=0;h=h||window.event;h.offsetX||0===h.offsetX?(m=h.offsetX,w=h.offsetY):h.layerX||0==h.layerX?(m=h.layerX,w=h.layerY):(m=h.pageX-h.target.offsetLeft,w=h.pageY-h.target.offsetTop);return{x:m,y:w}},Xa=!0,Oa=window.devicePixelRatio||1,Ka=1,ga=Xa?Oa/Ka:1,ca=function(h,m,w,s,v,y,E,F,O,N,R,Q,H){"undefined"===typeof H&&(H=1);E=E||0;F=F||"black";var J=15<s-m&&15<v-w?8:0.35*Math.min(s-m,v-w);h.beginPath();h.moveTo(m,w);h.save();h.fillStyle=
y;h.globalAlpha=H;h.fillRect(m,w,s-m,v-w);h.globalAlpha=1;0<E&&(H=0===E%2?0:0.5,h.beginPath(),h.lineWidth=E,h.strokeStyle=F,h.moveTo(m,w),h.rect(m-H,w-H,s-m+2*H,v-w+2*H),h.stroke());h.restore();!0===O&&(h.save(),h.beginPath(),h.moveTo(m,w),h.lineTo(m+J,w+J),h.lineTo(s-J,w+J),h.lineTo(s,w),h.closePath(),E=h.createLinearGradient((s+m)/2,w+J,(s+m)/2,w),E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=E,h.fill(),h.restore());!0===N&&(h.save(),h.beginPath(),h.moveTo(m,v),h.lineTo(m+
J,v-J),h.lineTo(s-J,v-J),h.lineTo(s,v),h.closePath(),E=h.createLinearGradient((s+m)/2,v-J,(s+m)/2,v),E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=E,h.fill(),h.restore());!0===R&&(h.save(),h.beginPath(),h.moveTo(m,w),h.lineTo(m+J,w+J),h.lineTo(m+J,v-J),h.lineTo(m,v),h.closePath(),E=h.createLinearGradient(m+J,(v+w)/2,m,(v+w)/2),E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,h.fill(),h.restore());!0===Q&&(h.save(),h.beginPath(),h.moveTo(s,
w),h.lineTo(s-J,w+J),h.lineTo(s-J,v-J),h.lineTo(s,v),E=h.createLinearGradient(s-J,(v+w)/2,s,(v+w)/2),E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,h.fill(),h.closePath(),h.restore())},Z=function(h){for(var m="",s=0;s<h.length;s++)m+=String.fromCharCode(Math.ceil(h.length/57/5)^h.charCodeAt(s));return m},$a=window&&window[Z("mnb`uhno")]&&window[Z("mnb`uhno")].href&&window[Z("mnb`uhno")].href.indexOf&&
...
this.options.zoomEnabled&&(this.zoomEnabled||this.panEnabled))for(d=0;d<this._axes.length;d++)if(null!==this._axes[d].viewportMinimum||null!==this._axes[d].viewportMaximum){c=!0;break}c?(Ia(this._zoomButton,this._resetButton),this._toolBar.style.border=this.toolbar.borderThickness+"px solid "+this.toolbar.borderColor,this._zoomButton.style.borderRight=this.toolbar.borderThickness+"px solid "+this.toolbar.borderColor,this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.borderThickness:
0)+"px solid "+this.toolbar.borderColor):(sa(this._zoomButton,this._resetButton),this._toolBar.style.border=this.toolbar.borderThickness+"px solid transparent",this.options.zoomEnabled&&(this.zoomEnabled=!0,this.panEnabled=!1));cb(this);this._processData();this.options.title&&(this.title=new wa(this,this.options.title),this.title.dockInsidePlotArea?a.push(this.title):this.title.setLayout());if(this.options.subtitles)for(d=0;d<this.options.subtitles.length;d++)c=new Fa(this,this.options.subtitles[d],
...
for(d=0;d<a.length;d++)a[d].setLayout(),a[d].render();var c=[];if(this.animatedRender){var b=ra(this.width,this.height);b.getContext("2d").drawImage(this.canvas,0,0,this.width,this.height)}fb(this);var a=this.ctx.miterLimit,e;this.ctx.miterLimit=3;v&&this._breaksCanvas&&(this._preRenderCtx.drawImage(this.canvas,0,0,this.width,this.height),this._preRenderCtx.drawImage(this._breaksCanvas,0,0,this.width,this.height),this._breaksCanvasCtx.globalCompositeOperation="source-atop",this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),this._preRenderCtx.clearRect(0,0,this.width,this.height));for(d=0;d<this.plotInfo.plotTypes.length;d++)for(var f=this.plotInfo.plotTypes[d],l=0;l<f.plotUnits.length;l++){var u=f.plotUnits[l],z=null;u.targetCanvas=null;this.animatedRender&&(u.targetCanvas=ra(this.width,this.height),u.targetCanvasCtx=u.targetCanvas.getContext("2d"),e=u.targetCanvasCtx.miterLimit,u.targetCanvasCtx.miterLimit=3);"line"===u.type?z=this.renderLine(u):"stepLine"===u.type?z=this.renderStepLine(u):
"spline"===u.type?z=this.renderSpline(u):"column"===u.type?z=this.renderColumn(u):"bar"===u.type?z=this.renderBar(u):"area"===u.type?z=this.renderArea(u):"stepArea"===u.type?z=this.renderStepArea(u):"splineArea"===u.type?z=this.renderSplineArea(u):"stackedColumn"===u.type?z=this.renderStackedColumn(u):"stackedColumn100"===u.type?z=this.renderStackedColumn100(u):"stackedBar"===u.type?z=this.renderStackedBar(u):"stackedBar100"===u.type?z=this.renderStackedBar100(u):"stackedArea"===u.type?z=this.renderStackedArea(u):
"stackedArea100"===u.type?z=this.renderStackedArea100(u):"bubble"===u.type?z=z=this.renderBubble(u):"scatter"===u.type?z=this.renderScatter(u):"pie"===u.type?this.renderPie(u):"doughnut"===u.type?this.renderPie(u):"funnel"===u.type?z=this.renderFunnel(u):"pyramid"===u.type?z=this.renderFunnel(u):"candlestick"===u.type?z=this.renderCandlestick(u):"ohlc"===u.type?z=this.renderCandlestick(u):"rangeColumn"===u.type?z=this.renderRangeColumn(u):"error"===u.type?z=this.renderError(u):"rangeBar"===u.type?
z=this.renderRangeBar(u):"rangeArea"===u.type?z=this.renderRangeArea(u):"rangeSplineArea"===u.type?z=this.renderRangeSplineArea(u):"waterfall"===u.type?z=this.renderWaterfall(u):"boxAndWhisker"===u.type&&(z=this.renderBoxAndWhisker(u));for(var k=0;k<u.dataSeriesIndexes.length;k++)this._dataInRenderedOrder.push(this.data[u.dataSeriesIndexes[k]]);this.animatedRender&&(u.targetCanvasCtx.miterLimit=e,z&&c.push(z))}this.ctx.miterLimit=a;this.animatedRender&&this._breaksCanvasCtx&&c.push({source:this._breaksCanvasCtx,
...
function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=0;l<a.dataSeriesIndexes.length;l++){var u=this.data[a.dataSeriesIndexes[l]],z=0,k=!1,n=!1,p;if("normal"===u.axisPlacement||"xySwapped"===u.axisPlacement)var q=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?
this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,g=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(u.dataPoints[z].x&&u.dataPoints[z].x.getTime||"dateTime"===u.xValueType)f=!0;for(z=0;z<u.dataPoints.length;z++){"undefined"===typeof u.dataPoints[z].x&&(u.dataPoints[z].x=z+(a.axisX.logarithmic?
1:0));u.dataPoints[z].x.getTime?(f=!0,b=u.dataPoints[z].x.getTime()):b=u.dataPoints[z].x;e=u.dataPoints[z].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);e<d.min&&"number"===typeof e&&(d.min=e);e>d.max&&"number"===typeof e&&(d.max=e);if(0<z){if(a.axisX.logarithmic){var r=b/u.dataPoints[z-1].x;1>r&&(r=1/r);c.minDiff>r&&1!==r&&(c.minDiff=r)}else r=b-u.dataPoints[z-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r);null!==e&&null!==u.dataPoints[z-1].y&&(a.axisY.logarithmic?(r=e/u.dataPoints[z-1].y,1>r&&(r=
1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e-u.dataPoints[z-1].y,0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r)))}if(b<q&&!k)null!==e&&(p=b);else{if(!k&&(k=!0,0<z)){z-=2;continue}if(b>g&&!n)n=!0;else if(b>g&&n)continue;u.dataPoints[z].label&&(a.axisX.labels[b]=u.dataPoints[z].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&p<b&&(c.viewPortMin=p):(e<d.viewPortMin&&"number"===typeof e&&(d.viewPortMin=e),e>d.viewPortMax&&"number"===typeof e&&(d.viewPortMax=
...
(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l[b]?l[b]+=e:(l[b]=e,z=Math.min(e,z)):u[b]?u[b]+=e:(u[b]=e,k=Math.max(e,k)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(d.dataPointYPositiveSums?(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,l),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,u)):(d.dataPointYPositiveSums=l,d.dataPointYNegativeSums=
u));p.axisX.valueType=p.xValueType=f?"dateTime":"number"}for(q in l)l.hasOwnProperty(q)&&!isNaN(q)&&(a=l[q],a<d.min&&(d.min=Math.min(a,z)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,z)),a>d.viewPortMax&&(d.viewPortMax=a)));for(q in u)u.hasOwnProperty(q)&&!isNaN(q)&&(a=u[q],a<d.min&&(d.min=a),a>d.max&&(d.max=Math.max(a,k)),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=a),a>d.viewPortMax&&(d.viewPortMax=Math.max(a,k))))}};m.prototype._processStacked100PlotUnit=
...
1].y,0>t&&(t*=-1),d.minDiff>t&&0!==t&&(d.minDiff=t)))}if(b<h&&!q)null!==e&&(r=b);else{if(!q&&(q=!0,0<p)){p-=2;continue}if(b>m&&!g)g=!0;else if(b>m&&g)continue;n.dataPoints[p].label&&(a.axisX.labels[b]=n.dataPoints[p].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&r<b&&(c.viewPortMin=r):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(u=!0),z[b]=z[b]?z[b]+Math.abs(e):
...
!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=0;l<a.dataSeriesIndexes.length;l++){var u=this.data[a.dataSeriesIndexes[l]],z=0,k=!1,n=!1,p=b=0;if("normal"===u.axisPlacement||"xySwapped"===u.axisPlacement)var q=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:
a.axisX.logarithmic?0:-Infinity,g=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(u.dataPoints[z].x&&u.dataPoints[z].x.getTime||"dateTime"===u.xValueType)f=!0;for(z=0;z<u.dataPoints.length;z++)"undefined"!==typeof u.dataPoints[z].isCumulativeSum&&!0===u.dataPoints[z].isCumulativeSum?(u.dataPointEOs[z].cumulativeSumYStartValue=
0,u.dataPointEOs[z].cumulativeSum=0===z?0:u.dataPointEOs[z-1].cumulativeSum,u.dataPoints[z].y=0===z?0:u.dataPointEOs[z-1].cumulativeSum):"undefined"!==typeof u.dataPoints[z].isIntermediateSum&&!0===u.dataPoints[z].isIntermediateSum?(u.dataPointEOs[z].cumulativeSumYStartValue=p,u.dataPointEOs[z].cumulativeSum=0===z?0:u.dataPointEOs[z-1].cumulativeSum,u.dataPoints[z].y=0===z?0:b,p=0===z?0:u.dataPointEOs[z-1].cumulativeSum,b=0):(e="number"!==typeof u.dataPoints[z].y?0:u.dataPoints[z].y,u.dataPointEOs[z].cumulativeSumYStartValue=
0===z?0:u.dataPointEOs[z-1].cumulativeSum,u.dataPointEOs[z].cumulativeSum=0===z?e:u.dataPointEOs[z-1].cumulativeSum+e,b+=e);for(z=0;z<u.dataPoints.length;z++)if("undefined"===typeof u.dataPoints[z].x&&(u.dataPoints[z].x=z+(a.axisX.logarithmic?1:0)),u.dataPoints[z].x.getTime?(f=!0,b=u.dataPoints[z].x.getTime()):b=u.dataPoints[z].x,e=u.dataPoints[z].y,b<c.min&&(c.min=b),b>c.max&&(c.max=b),u.dataPointEOs[z].cumulativeSum<d.min&&(d.min=u.dataPointEOs[z].cumulativeSum),u.dataPointEOs[z].cumulativeSum>
d.max&&(d.max=u.dataPointEOs[z].cumulativeSum),0<z&&(a.axisX.logarithmic?(p=b/u.dataPoints[z-1].x,1>p&&(p=1/p),c.minDiff>p&&1!==p&&(c.minDiff=p)):(p=b-u.dataPoints[z-1].x,0>p&&(p*=-1),c.minDiff>p&&0!==p&&(c.minDiff=p)),null!==e&&null!==u.dataPoints[z-1].y&&(a.axisY.logarithmic?(e=u.dataPointEOs[z].cumulativeSum/u.dataPointEOs[z-1].cumulativeSum,1>e&&(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=u.dataPointEOs[z].cumulativeSum-u.dataPointEOs[z-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=
e)))),!(b<q)||k){if(!k&&(k=!0,0<z)){z-=2;continue}if(b>g&&!n)n=!0;else if(b>g&&n)continue;u.dataPoints[z].label&&(a.axisX.labels[b]=u.dataPoints[z].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);0<z&&(u.dataPointEOs[z-1].cumulativeSum<d.viewPortMin&&(d.viewPortMin=u.dataPointEOs[z-1].cumulativeSum),u.dataPointEOs[z-1].cumulativeSum>d.viewPortMax&&(d.viewPortMax=u.dataPointEOs[z-1].cumulativeSum));u.dataPointEOs[z].cumulativeSum<d.viewPortMin&&(d.viewPortMin=u.dataPointEOs[z].cumulativeSum);
u.dataPointEOs[z].cumulativeSum>d.viewPortMax&&(d.viewPortMax=u.dataPointEOs[z].cumulativeSum)}u.axisX.valueType=u.xValueType=f?"dateTime":"number"}};m.prototype.calculateAutoBreaks=function(){function a(a,b,c,e){if(e)return c=Math.pow(Math.min(c*a/b,b/a),0.2),1>=c&&(c=Math.pow(1>a?1/a:Math.min(b/a,a),0.25)),{startValue:a*c,endValue:b/c};c=0.2*Math.min(c-b+a,b-a);0>=c&&(c=0.25*Math.min(b-a,Math.abs(a)));return{startValue:a+c,endValue:b-c}}function d(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){var b=
a.axisX.scaleBreaks&&a.axisX.scaleBreaks.autoCalculate&&1<=a.axisX.scaleBreaks.maxNumberOfAutoBreaks,c=a.axisY.scaleBreaks&&a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks;if(b||c)for(var d=a.axisY.dataInfo,f=a.axisX.dataInfo,g,k=f.min,l=f.max,n=d.min,p=d.max,f=f._dataRanges,d=d._dataRanges,q,u=0,z=0;z<a.dataSeriesIndexes.length;z++){var h=e.data[a.dataSeriesIndexes[z]];if(!(4>h.dataPoints.length))for(u=0;u<h.dataPoints.length;u++)if(b&&(q=(l+1-k)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||
...
z)/b);p<n[g].min&&(n[g].min=p);p>n[g].max&&(n[g].max=p)}delete this._axes[l].dataInfo.dataPointYPositiveSums}if(this._axes[l].dataInfo.dataPointYNegativeSums){q=this._axes[l].dataInfo.dataPointYNegativeSums;n=k;for(u in q)q.hasOwnProperty(u)&&!isNaN(u)&&(p=-1*q[u],s(p)||(g=Math.floor((p-z)/b),p<n[g].min&&(n[g].min=p),p>n[g].max&&(n[g].max=p)));delete this._axes[l].dataInfo.dataPointYNegativeSums}for(u=0;u<k.length-1;u++)if(n=k[u].max,isFinite(n))for(;u<k.length-1;)if(z=k[u+1].min,isFinite(z)){p=z-
n;p>b&&f.push({diff:p,start:n,end:z});break}else u++;if(this._axes[l].scaleBreaks.customBreaks)for(u=0;u<this._axes[l].scaleBreaks.customBreaks.length;u++)for(b=0;b<f.length;b++)if(this._axes[l].scaleBreaks.customBreaks[u].startValue<=f[b].start&&f[b].start<=this._axes[l].scaleBreaks.customBreaks[u].endValue||this._axes[l].scaleBreaks.customBreaks[u].startValue<=f[b].start&&f[b].start<=this._axes[l].scaleBreaks.customBreaks[u].endValue||f[b].start<=this._axes[l].scaleBreaks.customBreaks[u].startValue&&
...
else if(v)b=Wa(a,d,this._eventManager.ghostCtx);else for(c=0;c<this.legend.items.length;c++){var e=this.legend.items[c];a>=e.x1&&(a<=e.x2&&d>=e.y1&&d<=e.y2)&&(b=e.id)}return b};m.prototype.getAutoFontSize=jb;m.prototype.resetOverlayedCanvas=function(){this.overlaidCanvasCtx.clearRect(0,0,this.width,this.height)};m.prototype.clearCanvas=ib;m.prototype.attachEvent=function(a){this._events.push(a)};m.prototype._touchEventHandler=function(a){if(a.changedTouches&&this.interactivityEnabled){var d=[],c=
a.changedTouches,b=c?c[0]:a,e=null;switch(a.type){case "touchstart":case "MSPointerDown":d=["mousemove","mousedown"];this._lastTouchData=La(b);this._lastTouchData.time=new Date;break;case "touchmove":case "MSPointerMove":d=["mousemove"];break;case "touchend":case "MSPointerUp":var f=this._lastTouchData&&this._lastTouchData.time?new Date-this._lastTouchData.time:0,d="touchstart"===this._lastTouchEventType||"MSPointerDown"===this._lastTouchEventType||300>f?["mouseup","click"]:["mouseup"];break;default:return}if(!(c&&
1<c.length)){e=La(b);e.time=new Date;try{var l=e.y-this._lastTouchData.y,f=e.time-this._lastTouchData.time;if(1<Math.abs(l)&&this._lastTouchData.scroll||5<Math.abs(l)&&250>f)this._lastTouchData.scroll=!0}catch(u){}this._lastTouchEventType=a.type;if(this._lastTouchData.scroll&&this.zoomEnabled)this.isDrag&&this.resetOverlayedCanvas(),this.isDrag=!1;else for(c=0;c<d.length;c++)if(e=d[c],l=document.createEvent("MouseEvent"),l.initMouseEvent(e,!0,!0,window,1,b.screenX,b.screenY,b.clientX,b.clientY,!1,
...
3)||!p.logarithmic&&r<3*Math.abs(p.dataInfo.minDiff))||q<p.minimum||g>p.maximum))z.push(p),n.push({val1:q,val2:g}),u=!0;else if(!e){u=!1;break}}return{isValid:u,axesWithValidRange:z,axesRanges:n}};m.prototype.preparePlotArea=function(){var a=this.plotArea;!v&&(0<a.x1||0<a.y1)&&a.ctx.translate(a.x1,a.y1);if((this.axisX[0]||this.axisX2[0])&&(this.axisY[0]||this.axisY2[0])){var d=this.axisX[0]?this.axisX[0].lineCoordinates:this.axisX2[0].lineCoordinates;if(this.axisY&&0<this.axisY.length&&this.axisY[0]){var c=
this.axisY[0];a.x1=d.x1<d.x2?d.x1:c.lineCoordinates.x1;a.y1=d.y1<c.lineCoordinates.y1?d.y1:c.lineCoordinates.y1;a.x2=d.x2>c.lineCoordinates.x2?d.x2:c.lineCoordinates.x2;a.y2=d.y2>d.y1?d.y2:c.lineCoordinates.y2;a.width=a.x2-a.x1;a.height=a.y2-a.y1}this.axisY2&&0<this.axisY2.length&&this.axisY2[0]&&(c=this.axisY2[0],a.x1=d.x1<d.x2?d.x1:c.lineCoordinates.x1,a.y1=d.y1<c.lineCoordinates.y1?d.y1:c.lineCoordinates.y1,a.x2=d.x2>c.lineCoordinates.x2?d.x2:c.lineCoordinates.x2,a.y2=d.y2>d.y1?d.y2:c.lineCoordinates.y2,
a.width=a.x2-a.x1,a.height=a.y2-a.y1)}else d=this.layoutManager.getFreeSpace(),a.x1=d.x1,a.x2=d.x2,a.y1=d.y1,a.y2=d.y2,a.width=d.width,a.height=d.height;v||(a.canvas.width=a.width,a.canvas.height=a.height,a.canvas.style.left=a.x1+"px",a.canvas.style.top=a.y1+"px",(0<a.x1||0<a.y1)&&a.ctx.translate(-a.x1,-a.y1));a.layoutManager=new Ba(a.x1,a.y1,a.x2,a.y2,2)};m.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,f=0,l=f=e=0,u=0,z=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var n=
this._indexLabels[a],p=n.chartType.toLowerCase(),q,g,l=ka("indexLabelFontColor",n.dataPoint,n.dataSeries),r=ka("indexLabelFontSize",n.dataPoint,n.dataSeries),u=ka("indexLabelFontFamily",n.dataPoint,n.dataSeries),z=ka("indexLabelFontStyle",n.dataPoint,n.dataSeries),k=ka("indexLabelFontWeight",n.dataPoint,n.dataSeries),h=ka("indexLabelBackgroundColor",n.dataPoint,n.dataSeries);q=ka("indexLabelMaxWidth",n.dataPoint,n.dataSeries);g=ka("indexLabelWrap",n.dataPoint,n.dataSeries);var m=ka("indexLabelLineDashType",
n.dataPoint,n.dataSeries),t=ka("indexLabelLineColor",n.dataPoint,n.dataSeries),x=s(n.dataPoint.indexLabelLineThickness)?s(n.dataSeries.options.indexLabelLineThickness)?0:n.dataSeries.options.indexLabelLineThickness:n.dataPoint.indexLabelLineThickness,b=0<x?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,A={percent:null,total:null},C=null;if(0<=n.dataSeries.type.indexOf("stacked")||"pie"===n.dataSeries.type||"doughnut"===n.dataSeries.type)A=this.getPercentAndTotal(n.dataSeries,
n.dataPoint);if(n.dataSeries.indexLabelFormatter||n.dataPoint.indexLabelFormatter)C={chart:this,dataSeries:n.dataSeries,dataPoint:n.dataPoint,index:n.indexKeyword,total:A.total,percent:A.percent};var D=n.dataPoint.indexLabelFormatter?n.dataPoint.indexLabelFormatter(C):n.dataPoint.indexLabel?this.replaceKeywordsWithValue(n.dataPoint.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):n.dataSeries.indexLabelFormatter?n.dataSeries.indexLabelFormatter(C):n.dataSeries.indexLabel?this.replaceKeywordsWithValue(n.dataSeries.indexLabel,
n.dataPoint,n.dataSeries,null,n.indexKeyword):null;if(null!==D&&""!==D){var A=ka("indexLabelPlacement",n.dataPoint,n.dataSeries),C=ka("indexLabelOrientation",n.dataPoint,n.dataSeries),B=n.direction,e=n.dataSeries.axisX,f=n.dataSeries.axisY,w=!1,h=new ia(d,{x:0,y:0,maxWidth:q?q:0.5*this.width,maxHeight:g?5*r:1.5*r,angle:"horizontal"===C?0:-90,text:D,padding:0,backgroundColor:h,horizontalAlign:"left",fontSize:r,fontFamily:u,fontWeight:k,fontColor:l,fontStyle:z,textBaseline:"middle"});h.measureText();
...
e.viewportMinimum||n.dataPoint.x>e.viewportMaximum||Math.max.apply(null,n.dataPoint.y)<f.viewportMinimum||Math.min.apply(null,n.dataPoint.y)>f.viewportMaximum)continue}else if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum)continue;l=u=2;"horizontal"===C?(z=h.width,k=h.height):(k=h.width,z=h.height);if("normal"===this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))A="auto",u=4;else if(0<=p.indexOf("stacked"))"auto"===A&&(A="inside");else if("bubble"===p||"scatter"===
p)A="inside";q=n.point.x-("horizontal"===C?z/2:z/2-r/2);"inside"!==A?(e=c.y1,f=c.y2,0<B?(g=n.point.y+("horizontal"===C?r/2:0)-k-u-b,g<e&&(g="auto"===A?Math.max(n.point.y,e)+r/2+u:e+r/2+u,w=g+k>n.point.y)):(g=n.point.y+r/2+u+b,g>f-k&&(g="auto"===A?Math.min(n.point.y,f)+r/2-k-u:f+r/2-k,w=g<n.point.y))):(e=Math.max(n.bounds.y1,c.y1),f=Math.min(n.bounds.y2,c.y2-k+r/2),b=0<=p.indexOf("range")||"error"===p?0<B?Math.max(n.bounds.y1,c.y1)+r/2+u:Math.min(n.bounds.y2,c.y2)+r/2-k+u:(Math.max(n.bounds.y1,c.y1)+
Math.min(n.bounds.y2,c.y2))/2-k/2+r/2+("horizontal"===C?u:0),0<B?(g=Math.max(n.point.y,b),g<e&&("bubble"===p||"scatter"===p)&&(g=Math.max(n.point.y-k-u,c.y1+u))):(g=Math.min(n.point.y,b),g>f-k-u&&("bubble"===p||"scatter"===p)&&(g=Math.min(n.point.y+u,c.y2-k-u))),g=Math.min(g,f))}else 0<=p.indexOf("line")||0<=p.indexOf("area")||0<=p.indexOf("scatter")?(A="auto",l=4):0<=p.indexOf("stacked")?"auto"===A&&(A="inside"):"bubble"===p&&(A="inside"),g=n.point.y+r/2-k/2+u,"inside"!==A?(e=c.x1,f=c.x2,0>B?(q=
n.point.x-("horizontal"===C?z:z-r/2)-l-b,q<e&&(q="auto"===A?Math.max(n.point.x,e)+l:e+l,w=q+z>n.point.x)):(q=n.point.x+("horizontal"===C?0:r/2)+l+b,q>f-z-l-b&&(q="auto"===A?Math.min(n.point.x,f)-("horizontal"===C?z:z/2)-l:f-z-l,w=q<n.point.x))):(e=Math.max(n.bounds.x1,c.x1),Math.min(n.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===p?0>B?Math.max(n.bounds.x1,c.x1)+r/2+l:Math.min(n.bounds.x2,c.x2)-z/2-l+("horizontal"===C?0:r/2):(Math.max(n.bounds.x1,c.x1)+Math.min(n.bounds.x2,c.x2))/2+("horizontal"===
C?0:r/2),q=0>B?Math.max(n.point.x,b)-("horizontal"===C?z/2:0):Math.min(n.point.x,b)-z/2,q=Math.max(q,e));"vertical"===C&&(g+=k-r/2);h.x=q;h.y=g;h.render(!0);x&&("inside"!==A&&(0>p.indexOf("bar")&&("error"!==p||!n.axisSwapped)&&n.point.x>c.x1&&n.point.x<c.x2||!w)&&(0>p.indexOf("column")&&("error"!==p||n.axisSwapped)&&n.point.y>c.y1&&n.point.y<c.y2||!w))&&(d.lineWidth=x,d.strokeStyle=t?t:"gray",d.setLineDash&&d.setLineDash(O(m,x)),d.beginPath(),d.moveTo(n.point.x,n.point.y),0<=p.indexOf("bar")||"error"===
p&&n.axisSwapped?d.lineTo(q+(0<n.direction?-l:z+l)+("vertical"===C?-r/2:0),g+("vertical"===C?-k/2:k/2-r/2)-u):0<=p.indexOf("column")||"error"===p&&!n.axisSwapped?d.lineTo(q+z/2-("horizontal"===C?0:r/2),g+("vertical"===C?(g-k<n.point.y?0:-k)+u:(g-r/2<n.point.y?k:0)-r/2)):d.lineTo(q+z/2-("horizontal"===C?0:r/2),g+("vertical"===C?g-k<n.point.y?0:-k:(g-r/2<n.point.y?k:0)-r/2)),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0,
...
c.strokeStyle=r;var m=!0,t=0,x,s;c.beginPath();if(0<n.length){for(var C=!1,t=0;t<n.length;t++)if(x=n[t].x.getTime?n[t].x.getTime():n[t].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!C)))if("number"!==typeof n[t].y)0<t&&!(k.connectNullData||C||m)&&(c.stroke(),v&&b.stroke()),C=!0;else{x=a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(n[t].y);var D=k.dataPointIds[t];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:z,
dataPointIndex:t,x1:x,y1:s};m||C?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(x,s),v&&b.lineTo(x,s)):(c.beginPath(),c.moveTo(x,s),v&&(b.beginPath(),b.moveTo(x,s))),C=m=!1):(c.lineTo(x,s),v&&b.lineTo(x,s),0==t%500&&(c.stroke(),c.beginPath(),c.moveTo(x,s),v&&(b.stroke(),b.beginPath(),b.moveTo(x,s))));l={x:x,y:s};t<n.length-
...
h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var m=!0,t=0,x,s;c.beginPath();if(0<n.length){for(var C=!1,t=0;t<n.length;t++)if(x=n[t].getTime?n[t].x.getTime():n[t].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!C)))if("number"!==typeof n[t].y)0<t&&!(k.connectNullData||C||m)&&(c.stroke(),v&&b.stroke()),C=!0;else{var D=s;x=a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(n[t].y);var B=k.dataPointIds[t];this._eventManager.objectMap[B]=
{id:B,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:t,x1:x,y1:s};m||C?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(x,D),c.lineTo(x,s),v&&(b.lineTo(x,D),b.lineTo(x,s))):(c.beginPath(),c.moveTo(x,s),v&&(b.beginPath(),b.moveTo(x,s))),C=m=!1):(c.lineTo(x,D),v&&b.lineTo(x,D),c.lineTo(x,s),v&&b.lineTo(x,s),0==t%
500&&(c.stroke(),c.beginPath(),c.moveTo(x,s),v&&(b.stroke(),b.beginPath(),b.moveTo(x,s))));l={x:x,y:s};t<n.length-1&&(h!==(n[t].lineColor||r)||p!==(n[t].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,s),h=n[t].lineColor||r,c.strokeStyle=h,c.setLineDash&&(n[t].lineDashType?(p=n[t].lineDashType,c.setLineDash(O(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[t].markerSize||0<k.markerSize)D=k.getMarkerProperties(t,x,s,c),f.push(D),B=Q(B),v&&f.push({x:x,y:s,ctx:b,
type:D.type,size:D.size,color:B,borderColor:B,borderThickness:D.borderThickness});(n[t].indexLabel||k.indexLabel||n[t].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:n[t],dataSeries:k,point:{x:x,y:s},direction:0>n[t].y===a.axisY.reversed?1:-1,color:r})}c.stroke();v&&b.stroke()}}W.drawMarkers(f);v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
...
(b.strokeStyle=a[c+3].newStrokeStyle),a[c+3].newLineDashArray&&b.setLineDash(a[c+3].newLineDashArray),v&&(e.stroke(),e.beginPath(),e.moveTo(a[c+3].x,a[c+3].y));b.stroke();v&&e.stroke()}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=v?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx;b.save();var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],u=0;u<a.dataSeriesIndexes.length;u++){var z=a.dataSeriesIndexes[u],k=this.data[z];
b.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(b.setLineDash){var q=O(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=O(p,k.lineThickness);b.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:z};r=Q(r);e.strokeStyle=r;e.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];b.strokeStyle=r;var m=0,t,x,s=[];b.beginPath();if(0<n.length)for(x=!1,m=
0;m<n.length;m++)if(t=n[m].getTime?n[m].x.getTime():n[m].x,!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!x)))if("number"!==typeof n[m].y)0<m&&!x&&(k.connectNullData?b.setLineDash&&(0<s.length&&(k.options.nullDataLineDashType||!n[m-1].lineDashType))&&(s[s.length-1].newLineDashArray=q,p=k.nullDataLineDashType):(d(s),s=[])),x=!0;else{t=a.axisX.convertValueToPixel(t);x=a.axisY.convertValueToPixel(n[m].y);var C=k.dataPointIds[m];this._eventManager.objectMap[C]=
{id:C,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:m,x1:t,y1:x};s[s.length]={x:t,y:x};m<n.length-1&&(h!==(n[m].lineColor||r)||p!==(n[m].lineDashType||k.lineDashType))&&(h=n[m].lineColor||r,s[s.length-1].newStrokeStyle=h,b.setLineDash&&(n[m].lineDashType?(p=n[m].lineDashType,s[s.length-1].newLineDashArray=O(p,k.lineThickness)):(p=k.lineDashType,s[s.length-1].newLineDashArray=g)));if(0<n[m].markerSize||0<k.markerSize){var D=k.getMarkerProperties(m,t,x,b);l.push(D);C=Q(C);v&&l.push({x:t,y:x,
ctx:e,type:D.type,size:D.size,color:C,borderColor:C,borderThickness:D.borderThickness})}(n[m].indexLabel||k.indexLabel||n[m].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[m],dataSeries:k,point:{x:t,y:x},direction:0>n[m].y===a.axisY.reversed?1:-1,color:r});x=!1}d(s)}W.drawMarkers(l);v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,
...
a.axisX.convertValueToPixel(z);u=a.axisY.convertValueToPixel(r[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?l-p<<0:l+p<<0,t;0<=r[f].y?t=k:(t=u,u=k);u>t&&(b=u,u=t,t=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];ca(c,l,u,m,t,b,0,null,h&&0<=r[f].y,0>r[f].y&&h,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",
...
"#4572A7 ";for(k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){n=a.axisX.convertValueToPixel(b);var s=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=s+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y)u[b]=t[k].y+(u[b]?u[b]:0),0<u[b]&&(p=a.axisY.convertValueToPixel(u[b]),D="undefined"!==typeof f[b]?f[b]:q,f[b]=p);else if(a.axisY.scaleBreaks&&
0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)z[b]=t[k].y+(z[b]?z[b]:0),D=a.axisY.convertValueToPixel(z[b]),p="undefined"!==typeof l[b]?l[b]:q,l[b]=D;else if(p=a.axisY.convertValueToPixel(t[k].y),0<=t[k].y){var B="undefined"!==typeof f[b]?f[b]:0;p-=B;D=q-B;f[b]=B+(D-p)}else B=l[b]?l[b]:0,D=p+B,p=q+B,l[b]=B+(D-p);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ca(c,s,p,C,D,b,0,null,x&&0<=t[k].y,0>t[k].y&&x,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]=
{id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:s,y1:p,x2:C,y2:D};b=Q(b);v&&ca(this._eventManager.ghostCtx,s,p,C,D,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:t[k],dataSeries:m,point:{x:n,y:0<=t[k].y?p:D},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:s,y1:Math.min(p,D),x2:C,y2:Math.max(p,D)},color:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,
...
k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){n=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?100*(t[k].y/a.dataPointYSums[b]):0;var s=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=s+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y){u[b]=p+("undefined"!==typeof u[b]?u[b]:0);if(0>=u[b])continue;p=a.axisY.convertValueToPixel(u[b]);
D=f[b]?f[b]:q;f[b]=p}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)z[b]=p+("undefined"!==typeof z[b]?z[b]:0),D=a.axisY.convertValueToPixel(z[b]),p=l[b]?l[b]:q,l[b]=D;else if(p=a.axisY.convertValueToPixel(p),0<=t[k].y){var B="undefined"!==typeof f[b]?f[b]:0;p-=B;D=q-B;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y1-p)&&(p=e.y1);f[b]=B+(D-p)}else B="undefined"!==typeof l[b]?l[b]:0,D=p+B,p=q+B,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y2-D)&&(D=e.y2),l[b]=
B+(D-p);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ca(c,s,p,C,D,b,0,null,x&&0<=t[k].y,0>t[k].y&&x,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:s,y1:p,x2:C,y2:D};b=Q(b);v&&ca(this._eventManager.ghostCtx,s,p,C,D,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn100",dataPoint:t[k],dataSeries:m,
point:{x:n,y:0<=t[k].y?p:D},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:s,y1:Math.min(p,D),x2:C,y2:Math.max(p,D)},color:b})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.yScaleAnimation,easingFunction:L.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,u,z,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?
...
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],g=this.data[q],r=g.dataPoints;if(0<r.length){var h=5<p&&g.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<r.length;f++)if(r[f].getTime?z=r[f].x.getTime():z=r[f].x,!(z<a.axisX.dataInfo.viewPortMin||z>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){u=a.axisX.convertValueToPixel(z);l=a.axisY.convertValueToPixel(r[f].y);u=a.axisX.reversed?u+a.plotType.totalDataSeries*
...
typeof t[k].y){p=a.axisX.convertValueToPixel(b);var s=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=s+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y)u[b]=t[k].y+(u[b]?u[b]:0),0<u[b]&&(D=f[b]?f[b]:q,f[b]=n=a.axisY.convertValueToPixel(u[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)z[b]=t[k].y+(z[b]?z[b]:0),n=l[b]?l[b]:q,l[b]=D=a.axisY.convertValueToPixel(z[b]);else if(n=a.axisY.convertValueToPixel(t[k].y),
0<=t[k].y){var B=f[b]?f[b]:0;D=q+B;n+=B;f[b]=B+(n-D)}else B=l[b]?l[b]:0,D=n-B,n=q-B,l[b]=B+(n-D);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ca(c,D,s,n,C,b,0,null,x,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:D,y1:s,x2:n,y2:C};b=Q(b);v&&ca(this._eventManager.ghostCtx,D,s,n,C,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",
dataPoint:t[k],dataSeries:m,point:{x:0<=t[k].y?n:D,y:p},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(D,n),y1:s,x2:Math.max(D,n),y2:C},color:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],m=this.data[h],t=m.dataPoints;if(0<t.length){var x=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){p=a.axisX.convertValueToPixel(b);var s;s=0!==a.dataPointYSums[b]?100*(t[k].y/a.dataPointYSums[b]):0;var C=
p-a.plotType.plotUnits.length*g/2+a.index*g<<0,D=C+g<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y){u[b]=s+(u[b]?u[b]:0);if(0>=u[b])continue;s=f[b]?f[b]:q;f[b]=n=a.axisY.convertValueToPixel(u[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)z[b]=s+(z[b]?z[b]:0),n=l[b]?l[b]:q,l[b]=s=a.axisY.convertValueToPixel(z[b]);else if(n=a.axisY.convertValueToPixel(s),0<=t[k].y){var B=f[b]?f[b]:0;s=q+B;n+=B;a.dataSeriesIndexes.length-
1===r&&1>=Math.abs(e.x2-n)&&(n=e.x2);f[b]=B+(n-s)}else B=l[b]?l[b]:0,s=n-B,n=q-B,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x1-s)&&(s=e.x1),l[b]=B+(n-s);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ca(c,s,C,n,D,b,0,null,x,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:s,y1:C,x2:n,y2:D};b=Q(b);v&&ca(this._eventManager.ghostCtx,s,C,n,D,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||
t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:t[k],dataSeries:m,point:{x:0<=t[k].y?n:s,y:p},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(s,n),y1:C,x2:Math.max(s,n),y2:D},color:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,
0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.xScaleAnimation,easingFunction:L.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderArea=function(a){var d,c;function b(){D&&(0<g.lineThickness&&
f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=A:0>a.axisY.viewportMaximum?C=u.y1:0<a.axisY.viewportMinimum&&(C=A),f.lineTo(m,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,v&&(l.lineTo(m,C),l.lineTo(D.x,C),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,t),l.beginPath(),l.moveTo(m,t),D={x:m,y:t})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=v?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,
u=a.axisY.lineCoordinates,z=[],k=this.plotArea,n;f.save();v&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();v&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,z=g.id;this._eventManager.objectMap[z]={objectType:"dataSeries",dataSeriesIndex:q};z=Q(z);l.fillStyle=z;z=[];d=!0;var h=0,m,t,s,A=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),
...
(ja||d)||b(),ja=!0;else{m=a.axisX.convertValueToPixel(s);t=a.axisY.convertValueToPixel(r[h].y);d||ja?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=t,m=n.x,t=n.y,b(),f.moveTo(n.x,n.y),m=d,t=c,D=n,c=g.nullDataLineDashType,f.setLineDash(K)),f.lineTo(m,t),v&&l.lineTo(m,t)):(f.beginPath(),f.moveTo(m,t),v&&(l.beginPath(),l.moveTo(m,t)),D={x:m,y:t}),ja=d=!1):(f.lineTo(m,t),v&&l.lineTo(m,t),0==h%250&&b());n={x:m,
y:t};h<r.length-1&&(y!==(r[h].lineColor||w)||c!==(r[h].lineDashType||g.lineDashType))&&(b(),y=r[h].lineColor||w,f.strokeStyle=y,f.setLineDash&&(r[h].lineDashType?(c=r[h].lineDashType,f.setLineDash(O(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(aa))));var Y=g.dataPointIds[h];this._eventManager.objectMap[Y]={id:Y,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:m,y1:t};0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(h,m,t,f),z.push(s),Y=Q(Y),v&&
z.push({x:m,y:t,ctx:l,type:s.type,size:s.size,color:Y,borderColor:Y,borderThickness:s.borderThickness}));(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[h],dataSeries:g,point:{x:m,y:t},direction:0>r[h].y===a.axisY.reversed?1:-1,color:B})}b();W.drawMarkers(z)}}v&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,
...
0;z<a.dataSeriesIndexes.length;z++){var k=a.dataSeriesIndexes[z],n=this.data[k],p=n.dataPoints,l=n.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=Q(l);e.fillStyle=l;var l=[],q=0,g,r,h=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),m,t=null,s=[];if(0<p.length){var A=n._colorSet[q%n._colorSet.length],C=n.lineColor=n.options.lineColor||A,D=C;b.fillStyle=A;b.strokeStyle=C;b.lineWidth=n.lineThickness;var B="solid";if(b.setLineDash){var y=O(n.nullDataLineDashType,
n.lineThickness),B=n.lineDashType,E=O(B,n.lineThickness);b.setLineDash(E)}for(r=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!r)))if("number"!==typeof p[q].y)0<q&&!r&&(n.connectNullData?b.setLineDash&&(0<s.length&&(n.options.nullDataLineDashType||!p[q-1].lineDashType))&&(s[s.length-1].newLineDashArray=y,B=n.nullDataLineDashType):(d(),s=[])),r=!0;else{g=a.axisX.convertValueToPixel(g);r=a.axisY.convertValueToPixel(p[q].y);
var K=n.dataPointIds[q];this._eventManager.objectMap[K]={id:K,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:r};s[s.length]={x:g,y:r};q<p.length-1&&(D!==(p[q].lineColor||C)||B!==(p[q].lineDashType||n.lineDashType))&&(D=p[q].lineColor||C,s[s.length-1].newStrokeStyle=D,b.setLineDash&&(p[q].lineDashType?(B=p[q].lineDashType,s[s.length-1].newLineDashArray=O(B,n.lineThickness)):(B=n.lineDashType,s[s.length-1].newLineDashArray=E)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<n.markerSize)){var aa=
n.getMarkerProperties(q,g,r,b);l.push(aa);K=Q(K);v&&l.push({x:g,y:r,ctx:e,type:aa.type,size:aa.size,color:K,borderColor:K,borderThickness:aa.borderThickness})}(p[q].indexLabel||n.indexLabel||p[q].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:n,point:{x:g,y:r},direction:0>p[q].y===a.axisY.reversed?1:-1,color:A});r=!1}d();W.drawMarkers(l)}}v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation=
...
function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=A:0>a.axisY.viewportMaximum?C=u.y1:0<a.axisY.viewportMinimum&&(C=A),f.lineTo(m,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,v&&(l.lineTo(m,C),l.lineTo(D.x,C),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,t),l.beginPath(),l.moveTo(m,t),D={x:m,y:t})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=v?this._preRenderCtx:
e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,u=a.axisY.lineCoordinates,z=[],k=this.plotArea,n;f.save();v&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();v&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,z=g.id;this._eventManager.objectMap[z]={objectType:"dataSeries",dataSeriesIndex:q};z=Q(z);l.fillStyle=z;z=[];d=!0;var h=0,m,t,s,A=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),C,D=null;c=!1;if(0<r.length){var B=g._colorSet[h%g._colorSet.length],w=g.lineColor=g.options.lineColor||B,y=w;f.fillStyle=B;f.strokeStyle=w;f.lineWidth=g.lineThickness;var K="solid";if(f.setLineDash){var aa=O(g.nullDataLineDashType,g.lineThickness),K=g.lineDashType,E=O(K,g.lineThickness);f.setLineDash(E)}for(;h<r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var Y=t;"number"!==
typeof r[h].y?(g.connectNullData||(c||d)||b(),c=!0):(m=a.axisX.convertValueToPixel(s),t=a.axisY.convertValueToPixel(r[h].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||K===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=t,m=n.x,t=n.y,b(),f.moveTo(n.x,n.y),m=d,t=c,D=n,K=g.nullDataLineDashType,f.setLineDash(aa)),f.lineTo(m,Y),f.lineTo(m,t),v&&(l.lineTo(m,Y),l.lineTo(m,t))):(f.beginPath(),f.moveTo(m,t),v&&(l.beginPath(),l.moveTo(m,t)),D={x:m,y:t}),c=
d=!1):(f.lineTo(m,Y),v&&l.lineTo(m,Y),f.lineTo(m,t),v&&l.lineTo(m,t),0==h%250&&b()),n={x:m,y:t},h<r.length-1&&(y!==(r[h].lineColor||w)||K!==(r[h].lineDashType||g.lineDashType))&&(b(),y=r[h].lineColor||w,f.strokeStyle=y,f.setLineDash&&(r[h].lineDashType?(K=r[h].lineDashType,f.setLineDash(O(K,g.lineThickness))):(K=g.lineDashType,f.setLineDash(E)))),s=g.dataPointIds[h],this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:m,y1:t},0!==r[h].markerSize&&(0<r[h].markerSize||
0<g.markerSize)&&(Y=g.getMarkerProperties(h,m,t,f),z.push(Y),s=Q(s),v&&z.push({x:m,y:t,ctx:l,type:Y.type,size:Y.size,color:s,borderColor:s,borderThickness:Y.borderThickness})),(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:r[h],dataSeries:g,point:{x:m,y:t},direction:0>r[h].y===a.axisY.reversed?1:-1,color:B}))}b();W.drawMarkers(z)}}v&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation=
...
function(a){function d(){if(!(1>k.length)){for(0<B.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);v&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=B.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();v&&(s.closePath(),s.fill(),s.beginPath());k=[]}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=v?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],u=this.plotArea,h=[],k=[],n=[],p=[],q=0,g,r,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:
0),s=this._eventManager.ghostCtx,t,x,A;v&&s.beginPath();b.save();v&&s.save();b.beginPath();b.rect(u.x1,u.y1,u.width,u.height);b.clip();v&&(s.beginPath(),s.rect(u.x1,u.y1,u.width,u.height),s.clip());for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var D=a.dataSeriesIndexes[C],B=this.data[D],w=B.dataPoints;B.dataPointIndexes=[];for(q=0;q<w.length;q++)D=w[q].x.getTime?w[q].x.getTime():w[q].x,B.dataPointIndexes[D]=q,e[D]||(n.push(D),e[D]=!0);n.sort(Na)}for(C=0;C<a.dataSeriesIndexes.length;C++){D=a.dataSeriesIndexes[C];
B=this.data[D];w=B.dataPoints;x=!0;k=[];q=B.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:D};q=Q(q);s.fillStyle=q;if(0<n.length){var e=B._colorSet[0],y=B.lineColor=B.options.lineColor||e,K=y;b.fillStyle=e;b.strokeStyle=y;b.lineWidth=B.lineThickness;A="solid";if(b.setLineDash){var aa=O(B.nullDataLineDashType,B.lineThickness);A=B.lineDashType;var E=O(A,B.lineThickness);b.setLineDash(E)}for(var Y=!0,q=0;q<n.length;q++){var f=n[q],fa=null,fa=0<=B.dataPointIndexes[f]?w[B.dataPointIndexes[f]]:
{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!B.connectNullData||!Y)))if("number"!==typeof fa.y)B.connectNullData||(Y||x)||d(),Y=!0;else{g=a.axisX.convertValueToPixel(f);var la=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=fa.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(fa.y),r-=la;k.push({x:g,y:m-la});h[f]=m-r;x||Y?(!x&&
B.connectNullData?(b.setLineDash&&(B.options.nullDataLineDashType||A===B.lineDashType&&B.lineDashType!==B.nullDataLineDashType)&&(x=k.pop(),A=k[k.length-1],d(),b.moveTo(t.x,t.y),k.push(A),k.push(x),A=B.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,r),v&&s.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),v&&(s.beginPath(),s.moveTo(g,r))),Y=x=!1):(b.lineTo(g,r),v&&s.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),v&&s.moveTo(g,r),k.push({x:g,y:m-la})));t={x:g,y:r};q<w.length-1&&(K!==(w[q].lineColor||y)||A!==
(w[q].lineDashType||B.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:m-la}),K=w[q].lineColor||y,b.strokeStyle=K,b.setLineDash&&(w[q].lineDashType?(A=w[q].lineDashType,b.setLineDash(O(A,B.lineThickness))):(A=B.lineDashType,b.setLineDash(E))));if(0<=B.dataPointIndexes[f]){var F=B.dataPointIds[B.dataPointIndexes[f]];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:B.dataPointIndexes[f],x1:g,y1:r}}0<=B.dataPointIndexes[f]&&0!==fa.markerSize&&
(0<fa.markerSize||0<B.markerSize)&&(la=B.getMarkerProperties(B.dataPointIndexes[f],g,r,b),l.push(la),f=Q(F),v&&l.push({x:g,y:r,ctx:s,type:la.type,size:la.size,color:f,borderColor:f,borderThickness:la.borderThickness}));(fa.indexLabel||B.indexLabel||fa.indexLabelFormatter||B.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:fa,dataSeries:B,point:{x:g,y:r},direction:0>w[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);v&&s.moveTo(g,r)}delete B.dataPointIndexes}W.drawMarkers(l);
...
easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<B.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);v&&A.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=B.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();v&&(A.closePath(),A.fill(),A.beginPath());k=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=v?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,u=[],h=[],k=[],n=[],p=[],q=
0,g,r,m,s,t,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),A=this._eventManager.ghostCtx;b.save();v&&A.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();v&&(A.beginPath(),A.rect(l.x1,l.y1,l.width,l.height),A.clip());for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var w=a.dataSeriesIndexes[C],B=this.data[w],y=B.dataPoints;B.dataPointIndexes=[];for(q=0;q<y.length;q++)w=y[q].x.getTime?y[q].x.getTime():y[q].x,B.dataPointIndexes[w]=q,e[w]||(n.push(w),e[w]=
!0);n.sort(Na)}for(C=0;C<a.dataSeriesIndexes.length;C++){w=a.dataSeriesIndexes[C];B=this.data[w];y=B.dataPoints;s=!0;e=B.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:w};e=Q(e);A.fillStyle=e;k=[];if(0<n.length){var e=B._colorSet[q%B._colorSet.length],E=B.lineColor=B.options.lineColor||e,K=E;b.fillStyle=e;b.strokeStyle=E;b.lineWidth=B.lineThickness;t="solid";if(b.setLineDash){var aa=O(B.nullDataLineDashType,B.lineThickness);t=B.lineDashType;var F=O(t,B.lineThickness);
b.setLineDash(F)}for(var Y=!0,q=0;q<n.length;q++){var f=n[q],fa=null,fa=0<=B.dataPointIndexes[f]?y[B.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!B.connectNullData||!Y)))if("number"!==typeof fa.y)B.connectNullData||(Y||s)||d(),Y=!0;else{var la;la=0!==a.dataPointYSums[f]?100*(fa.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);var ba=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=
la+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(la),r-=ba;k.push({x:g,y:x-ba});h[f]=x-r;s||Y?(!s&&B.connectNullData?(b.setLineDash&&(B.options.nullDataLineDashType||t===B.lineDashType&&B.lineDashType!==B.nullDataLineDashType)&&(s=k.pop(),t=k[k.length-1],d(),b.moveTo(m.x,m.y),k.push(t),k.push(s),t=B.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,r),v&&A.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),v&&(A.beginPath(),A.moveTo(g,
r))),Y=s=!1):(b.lineTo(g,r),v&&A.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),v&&A.moveTo(g,r),k.push({x:g,y:x-ba})));m={x:g,y:r};q<y.length-1&&(K!==(y[q].lineColor||E)||t!==(y[q].lineDashType||B.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:x-ba}),K=y[q].lineColor||E,b.strokeStyle=K,b.setLineDash&&(y[q].lineDashType?(t=y[q].lineDashType,b.setLineDash(O(t,B.lineThickness))):(t=B.lineDashType,b.setLineDash(F))));if(0<=B.dataPointIndexes[f]){var G=B.dataPointIds[B.dataPointIndexes[f]];
this._eventManager.objectMap[G]={id:G,objectType:"dataPoint",dataSeriesIndex:w,dataPointIndex:B.dataPointIndexes[f],x1:g,y1:r}}0<=B.dataPointIndexes[f]&&0!==fa.markerSize&&(0<fa.markerSize||0<B.markerSize)&&(ba=B.getMarkerProperties(q,g,r,b),u.push(ba),f=Q(G),v&&u.push({x:g,y:r,ctx:A,type:ba.type,size:ba.size,color:f,borderColor:f,borderThickness:ba.borderThickness}));(fa.indexLabel||B.indexLabel||fa.indexLabelFormatter||B.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:fa,
dataSeries:B,point:{x:g,y:r},direction:0>y[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);v&&A.moveTo(g,r)}delete B.dataPointIndexes}W.drawMarkers(u);v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),A.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderBubble=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();v&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();v&&(this._eventManager.ghostCtx.beginPath(),
...
if(0<x.length)for(var A=5<r&&t.bevelEnabled?!0:!1,u=0;u<x.length;u++)if(x[u].getTime?g=x[u].x.getTime():g=x[u].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(x[u].y)&&x[u].y.length&&"number"===typeof x[u].y[0]&&"number"===typeof x[u].y[1]&&"number"===typeof x[u].y[2]&&"number"===typeof x[u].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(x[u].y[0]);n=a.axisY.convertValueToPixel(x[u].y[1]);p=a.axisY.convertValueToPixel(x[u].y[2]);q=a.axisY.convertValueToPixel(x[u].y[3]);
var C=h-r/2<<0,D=C+r<<0,f=t.options.fallingColor?t.fallingColor:t._colorSet[0],e=x[u].color?x[u].color:t._colorSet[0],B=Math.round(Math.max(1,0.15*r)),y=0===B%2?0:0.5,E=t.dataPointIds[u];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:w,dataPointIndex:u,x1:C,y1:k,x2:D,y2:n,x3:h,y3:p,x4:h,y4:q,borderThickness:B,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=B;b.lineWidth=Math.max(B,4);"candlestick"===t.type?(c.moveTo(h-y,n),c.lineTo(h-y,Math.min(k,q)),c.stroke(),c.moveTo(h-
y,Math.max(k,q)),c.lineTo(h-y,p),c.stroke(),ca(c,C,Math.min(k,q),D,Math.max(k,q),x[u].y[0]<=x[u].y[3]?t.risingColor:f,B,e,A,A,!1,!1,t.fillOpacity),v&&(e=Q(E),b.strokeStyle=e,b.moveTo(h-y,n),b.lineTo(h-y,Math.min(k,q)),b.stroke(),b.moveTo(h-y,Math.max(k,q)),b.lineTo(h-y,p),b.stroke(),ca(b,C,Math.min(k,q),D,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===t.type&&(c.moveTo(h-y,n),c.lineTo(h-y,p),c.stroke(),c.beginPath(),c.moveTo(h,k),c.lineTo(C,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(D,q),
c.stroke(),v&&(e=Q(E),b.strokeStyle=e,b.moveTo(h-y,n),b.lineTo(h-y,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(C,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(D,q),b.stroke()));(x[u].indexLabel||t.indexLabel||x[u].indexLabelFormatter||t.indexLabelFormatter)&&this._indexLabels.push({chartType:t.type,dataPoint:x[u],dataSeries:t,point:{x:C+(D-C)/2,y:a.axisY.reversed?p:n},direction:1,bounds:{x1:C,y1:Math.min(n,p),x2:D,y2:Math.max(n,p)},color:e})}}v&&(d.drawImage(this._preRenderCanvas,0,0,
...
f.height);c.clip();v&&(b.beginPath(),b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var m=!1,m=!!a.axisY.reversed,w=0;w<a.dataSeriesIndexes.length;w++){var t=a.dataSeriesIndexes[w],x=this.data[t],A=x.dataPoints;if(0<A.length)for(var C=5<r&&x.bevelEnabled?!0:!1,l=0;l<A.length;l++)if(A[l].getTime?g=A[l].x.getTime():g=A[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(A[l].y)&&A[l].y.length&&"number"===typeof A[l].y[0]&&"number"===typeof A[l].y[1]&&"number"===typeof A[l].y[2]&&
"number"===typeof A[l].y[3]&&"number"===typeof A[l].y[4]&&5===A[l].y.length){u=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(A[l].y[0]);k=a.axisY.convertValueToPixel(A[l].y[1]);n=a.axisY.convertValueToPixel(A[l].y[2]);p=a.axisY.convertValueToPixel(A[l].y[3]);q=a.axisY.convertValueToPixel(A[l].y[4]);var D=u-r/2<<0,B=u+r/2<<0,e=A[l].color?A[l].color:x._colorSet[0],y=Math.round(Math.max(1,0.15*r)),E=0===y%2?0:0.5,K=A[l].whiskerColor?A[l].whiskerColor:A[l].color?x.whiskerColor?x.whiskerColor:
A[l].color:x.whiskerColor?x.whiskerColor:e,aa="number"===typeof A[l].whiskerThickness?A[l].whiskerThickness:"number"===typeof x.options.whiskerThickness?x.whiskerThickness:y,F=A[l].whiskerDashType?A[l].whiskerDashType:x.whiskerDashType,Y=s(A[l].whiskerLength)?s(x.options.whiskerLength)?r:x.whiskerLength:A[l].whiskerLength,Y="number"===typeof Y?0>=Y?0:Y>=r?r:Y:"string"===typeof Y?parseInt(Y)*r/100>r?r:parseInt(Y)*r/100:r,fa=1===Math.round(aa)%2?0.5:0,la=A[l].stemColor?A[l].stemColor:A[l].color?x.stemColor?
x.stemColor:A[l].color:x.stemColor?x.stemColor:e,ba="number"===typeof A[l].stemThickness?A[l].stemThickness:"number"===typeof x.options.stemThickness?x.stemThickness:y,G=1===Math.round(ba)%2?0.5:0,J=A[l].stemDashType?A[l].stemDashType:x.stemDashType,H=A[l].lineColor?A[l].lineColor:A[l].color?x.lineColor?x.lineColor:A[l].color:x.lineColor?x.lineColor:e,N="number"===typeof A[l].lineThickness?A[l].lineThickness:"number"===typeof x.options.lineThickness?x.lineThickness:y,R=A[l].lineDashType?A[l].lineDashType:
x.lineDashType,M=1===Math.round(N)%2?0.5:0,U=x.upperBoxColor,va=x.lowerBoxColor,qa=s(x.options.fillOpacity)?1:x.fillOpacity,P=x.dataPointIds[l];this._eventManager.objectMap[P]={id:P,objectType:"dataPoint",dataSeriesIndex:t,dataPointIndex:l,x1:D,y1:h,x2:B,y2:k,x3:u,y3:n,x4:u,y4:p,y5:q,borderThickness:y,color:e,stemThickness:ba,stemColor:la,whiskerThickness:aa,whiskerLength:Y,whiskerColor:K,lineThickness:N,lineColor:H};c.save();0<ba&&(c.beginPath(),c.strokeStyle=la,c.lineWidth=ba,c.setLineDash&&c.setLineDash(O(J,
ba)),c.moveTo(u-G,k),c.lineTo(u-G,h),c.stroke(),c.moveTo(u-G,p),c.lineTo(u-G,n),c.stroke());c.restore();b.lineWidth=Math.max(y,4);c.beginPath();ca(c,D,Math.min(q,k),B,Math.max(k,q),va,0,e,m?C:!1,m?!1:C,!1,!1,qa);c.beginPath();ca(c,D,Math.min(n,q),B,Math.max(q,n),U,0,e,m?!1:C,m?C:!1,!1,!1,qa);c.beginPath();c.lineWidth=y;c.strokeStyle=e;c.rect(D-E,Math.min(k,n)-E,B-D+2*E,Math.max(k,n)-Math.min(k,n)+2*E);c.stroke();c.save();0<N&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(O(R,N)),c.strokeStyle=
H,c.lineWidth=N,c.moveTo(D,q-M),c.lineTo(B,q-M),c.stroke());c.restore();c.save();0<aa&&(c.beginPath(),c.setLineDash&&c.setLineDash(O(F,aa)),c.strokeStyle=K,c.lineWidth=aa,c.moveTo(u-Y/2<<0,p-fa),c.lineTo(u+Y/2<<0,p-fa),c.stroke(),c.moveTo(u-Y/2<<0,h+fa),c.lineTo(u+Y/2<<0,h+fa),c.stroke());c.restore();v&&(e=Q(P),b.strokeStyle=e,b.lineWidth=ba,0<ba&&(b.moveTo(u-E-G,k),b.lineTo(u-E-G,Math.max(h,p)),b.stroke(),b.moveTo(u-E-G,Math.min(h,p)),b.lineTo(u-E-G,n),b.stroke()),ca(b,D,Math.max(k,n),B,Math.min(k,
n),e,0,null,!1,!1,!1,!1),0<aa&&(b.beginPath(),b.lineWidth=aa,b.moveTo(u+Y/2,p-fa),b.lineTo(u-Y/2,p-fa),b.stroke(),b.moveTo(u+Y/2,h+fa),b.lineTo(u-Y/2,h+fa),b.stroke()));(A[l].indexLabel||x.indexLabel||A[l].indexLabelFormatter||x.indexLabelFormatter)&&this._indexLabels.push({chartType:x.type,dataPoint:A[l],dataSeries:x,point:{x:D+(B-D)/2,y:a.axisY.reversed?h:p},direction:1,bounds:{x1:D,y1:Math.min(h,p),x2:B,y2:Math.max(h,p)},color:e})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
0.9*(e.width*(a.axisX.logarithmic?Math.log(k)/Math.log(a.axisX.range):Math.abs(k)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>l&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<f)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));k<f&&(k=f);k>l&&(k=l);c.save();v&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();v&&(this._eventManager.ghostCtx.beginPath(),
...
a.axisY.convertValueToPixel(g[f].y[0]);u=a.axisY.convertValueToPixel(g[f].y[1]);var m=a.axisX.reversed?b+a.plotType.totalDataSeries*k/2-(a.previousDataSeriesCount+n)*k<<0:b-a.plotType.totalDataSeries*k/2+(a.previousDataSeriesCount+n)*k<<0,w=a.axisX.reversed?m-k<<0:m+k<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>u){var t=l;l=u;u=t}t=q.dataPointIds[f];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:m,y1:l,x2:w,y2:u};ca(c,m,l,w,
u,b,0,b,r,r,!1,!1,q.fillOpacity);b=Q(t);v&&ca(this._eventManager.ghostCtx,m,l,w,u,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:m+(w-m)/2,y:g[f].y[1]>=g[f].y[0]?u:l},direction:g[f].y[1]>=g[f].y[0]?-1:1,bounds:{x1:m,y1:Math.min(l,u),x2:w,y2:Math.max(l,u)},color:b}),this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:1,
point:{x:m+(w-m)/2,y:g[f].y[1]>=g[f].y[0]?l:u},direction:g[f].y[1]>=g[f].y[0]?1:-1,bounds:{x1:m,y1:Math.min(l,u),x2:w,y2:Math.max(l,u)},color:b})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,
this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderError=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d,b=a.axisY._position?"left"===a.axisY._position||"right"===a.axisY._position?!1:!0:!1;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=!1,l=this.plotArea,u=0,h,k,n,
p,q,g,r,m=a.axisX.dataInfo.minDiff;isFinite(m)||(m=0.3*Math.abs(a.axisX.range));c.save();v&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();v&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.clip());for(var w=0,t=0;t<this.data.length;t++)!this.data[t].type.match(/(bar|column)/ig)||!this.data[t].visible||this.data[t].type.match(/(stacked)/ig)&&w||w++;for(var x=0;x<a.dataSeriesIndexes.length;x++){var A=
a.dataSeriesIndexes[x],C=this.data[A],D=C.dataPoints,B=s(C._linkedSeries)?!1:C._linkedSeries.type.match(/(bar|column)/ig)&&C._linkedSeries.visible?!0:!1,E=0;if(B)for(e=C._linkedSeries.id,t=0;t<e;t++)!this.data[t].type.match(/(bar|column)/ig)||!this.data[t].visible||this.data[t].type.match(/(stacked)/ig)&&E||(this.data[t].type.match(/(range)/ig)&&(f=!0),E++);e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;u=this.options.dataPointMaxWidth?this.dataPointMaxWidth:
...
0;this.dataPointMaxWidth&&e>u&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,u));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&u<e)&&(u=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));t<e&&(t=e);t>u&&(t=u);if(0<D.length)for(var F=C._colorSet,u=0;u<D.length;u++){var e=C.lineColor=C.options.color?C.options.color:F[0],K={color:D[u].whiskerColor?D[u].whiskerColor:D[u].color?C.whiskerColor?C.whiskerColor:D[u].color:C.whiskerColor?C.whiskerColor:e,thickness:s(D[u].whiskerThickness)?
C.whiskerThickness:D[u].whiskerThickness,dashType:D[u].whiskerDashType?D[u].whiskerDashType:C.whiskerDashType,length:s(D[u].whiskerLength)?s(C.options.whiskerLength)?t:C.options.whiskerLength:D[u].whiskerLength,trimLength:s(D[u].whiskerLength)?s(C.options.whiskerLength)?50:0:0};K.length="number"===typeof K.length?0>=K.length?0:K.length>=t?t:K.length:"string"===typeof K.length?parseInt(K.length)*t/100>t?t:parseInt(K.length)*t/100>t:t;K.thickness="number"===typeof K.thickness?0>K.thickness?0:Math.round(K.thickness):
2;var aa={color:D[u].stemColor?D[u].stemColor:D[u].color?C.stemColor?C.stemColor:D[u].color:C.stemColor?C.stemColor:e,thickness:D[u].stemThickness?D[u].stemThickness:C.stemThickness,dashType:D[u].stemDashType?D[u].stemDashType:C.stemDashType};aa.thickness="number"===typeof aa.thickness?0>aa.thickness?0:Math.round(aa.thickness):2;D[u].getTime?r=D[u].x.getTime():r=D[u].x;if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax)&&!s(D[u].y)&&D[u].y.length&&"number"===typeof D[u].y[0]&&"number"===
typeof D[u].y[1]){var ja=a.axisX.convertValueToPixel(r);b?k=ja:h=ja;ja=a.axisY.convertValueToPixel(D[u].y[0]);b?n=ja:q=ja;ja=a.axisY.convertValueToPixel(D[u].y[1]);b?p=ja:g=ja;b?(q=a.axisX.reversed?k+(B?w:1)*t/2-(B?E-1:0)*t<<0:k-(B?w:1)*t/2+(B?E-1:0)*t<<0,g=a.axisX.reversed?q-t<<0:q+t<<0):(n=a.axisX.reversed?h+(B?w:1)*t/2-(B?E-1:0)*t<<0:h-(B?w:1)*t/2+(B?E-1:0)*t<<0,p=a.axisX.reversed?n-t<<0:n+t<<0);!b&&q>g&&(ja=q,q=g,g=ja);b&&n>p&&(ja=n,n=p,p=ja);ja=C.dataPointIds[u];this._eventManager.objectMap[ja]=
{id:ja,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:u,x1:Math.min(n,p),y1:Math.min(q,g),x2:Math.max(p,n),y2:Math.max(g,q),isXYSwapped:b,stemProperties:aa,whiskerProperties:K};y(c,Math.min(n,p),Math.min(q,g),Math.max(p,n),Math.max(g,q),e,K,aa,b);v&&y(this._eventManager.ghostCtx,n,q,p,g,e,K,aa,b);if(D[u].indexLabel||C.indexLabel||D[u].indexLabelFormatter||C.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:D[u],dataSeries:C,indexKeyword:0,point:{x:b?D[u].y[1]>=D[u].y[0]?
n:p:n+(p-n)/2,y:b?q+(g-q)/2:D[u].y[1]>=D[u].y[0]?g:q},direction:D[u].y[1]>=D[u].y[0]?-1:1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b}),this._indexLabels.push({chartType:"error",dataPoint:D[u],dataSeries:C,indexKeyword:1,point:{x:b?D[u].y[1]>=D[u].y[0]?p:n:n+(p-n)/2,y:b?q+(g-q)/2:D[u].y[1]>=D[u].y[0]?q:g},direction:D[u].y[1]>=D[u].y[0]?1:-1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,
g)},color:e,axisSwapped:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,
dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,u,h,k,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;l=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:
...
l<f)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));n<f&&(n=f);n>l&&(n=l);c.save();v&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();v&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints;if(0<r.length){var m=5<n&&g.bevelEnabled?!0:!1;c.strokeStyle=
...
a.axisX.reversed?h-n<<0:h+n<<0;l>u&&(b=l,l=u,u=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];ca(c,l,h,u,w,b,0,null,m,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:h,x2:u,y2:w};b=Q(b);v&&ca(this._eventManager.ghostCtx,l,h,u,w,b,0,null,!1,!1,!1,!1);if(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],
dataSeries:g,indexKeyword:0,point:{x:r[f].y[1]>=r[f].y[0]?l:u,y:h+(w-h)/2},direction:r[f].y[1]>=r[f].y[0]?-1:1,bounds:{x1:Math.min(l,u),y1:h,x2:Math.max(l,u),y2:w},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:1,point:{x:r[f].y[1]>=r[f].y[0]?u:l,y:h+(w-h)/2},direction:r[f].y[1]>=r[f].y[0]?1:-1,bounds:{x1:Math.min(l,u),y1:h,x2:Math.max(l,u),y2:w},color:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation=
...
this.plotArea.ctx,b=v?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();v&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();v&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var u=0;u<a.dataSeriesIndexes.length;u++){var h=[],k=a.dataSeriesIndexes[u],n=this.data[k],p=n.dataPoints,f=n.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=Q(f);e.fillStyle=f;var f=[],q=
!0,g=0,r,m,s,t,x=null;if(0<p.length){var w=n._colorSet[g%n._colorSet.length],C=n.lineColor=n.options.lineColor||w,D=C;b.fillStyle=w;b.strokeStyle=C;b.lineWidth=n.lineThickness;var B="solid";if(b.setLineDash){var y=O(n.nullDataLineDashType,n.lineThickness),B=n.lineDashType,E=O(B,n.lineThickness);b.setLineDash(E)}for(var K=!0;g<p.length;g++)if(t=p[g].x.getTime?p[g].x.getTime():p[g].x,!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!K)))if(null!==p[g].y&&p[g].y.length&&
"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){r=a.axisX.convertValueToPixel(t);m=a.axisY.convertValueToPixel(p[g].y[0]);s=a.axisY.convertValueToPixel(p[g].y[1]);q||K?(n.connectNullData&&!q?(b.setLineDash&&(n.options.nullDataLineDashType||B===n.lineDashType&&n.lineDashType!==n.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=E,B=n.nullDataLineDashType,b.setLineDash(y)),b.lineTo(r,m),v&&e.lineTo(r,m),h.push({x:r,y1:m,y2:s})):(b.beginPath(),b.moveTo(r,m),x={x:r,y:m},h=[],h.push({x:r,
y1:m,y2:s}),v&&(e.beginPath(),e.moveTo(r,m))),K=q=!1):(b.lineTo(r,m),h.push({x:r,y1:m,y2:s}),v&&e.lineTo(r,m),0==g%250&&d());t=n.dataPointIds[g];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:r,y1:m,y2:s};g<p.length-1&&(D!==(p[g].lineColor||C)||B!==(p[g].lineDashType||n.lineDashType))&&(d(),D=p[g].lineColor||C,h[h.length-1].newStrokeStyle=D,b.strokeStyle=D,b.setLineDash&&(p[g].lineDashType?(B=p[g].lineDashType,h[h.length-1].newLineDashArray=O(B,
n.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(B=n.lineDashType,h[h.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<n.markerSize)){var aa=n.getMarkerProperties(g,r,s,b);f.push(aa);var F=Q(t);v&&f.push({x:r,y:s,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness});aa=n.getMarkerProperties(g,r,m,b);f.push(aa);F=Q(t);v&&f.push({x:r,y:m,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness})}if(p[g].indexLabel||
...
d[f+3].y)}}b.beginPath();b.moveTo(d[0].x,d[0].y);v&&(e.beginPath(),e.moveTo(d[0].x,d[0].y));for(f=0;f<d.length-3;f+=3)b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y),v&&e.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y);d=w(y,2);b.lineTo(y[y.length-1].x,y[y.length-1].y);for(f=d.length-1;2<f;f-=3)b.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y),v&&e.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y);b.closePath();b.globalAlpha=
k.fillOpacity;b.fill();v&&(e.closePath(),e.fill());b.globalAlpha=1;if(0<k.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(d[0].x,d[0].y);for(var g=f=0;f<d.length-3;f+=3,g++){if(s[g].newStrokeStyle||s[g].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,d[f].y),s[g].newStrokeStyle&&(b.strokeStyle=s[g].newStrokeStyle),s[g].newLineDashArray&&b.setLineDash(s[g].newLineDashArray);b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}d=w(s,
...
f=[],l=this.plotArea;b.save();v&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();v&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var h=0;h<a.dataSeriesIndexes.length;h++){var m=a.dataSeriesIndexes[h],k=this.data[m],n=k.dataPoints,f=k.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:m};f=Q(f);e.fillStyle=f;var f=[],p=0,q,g,r,s=[],y=[];if(0<n.length){var t=k._colorSet[p%k._colorSet.length],x=k.lineColor=k.options.lineColor||t,A=x;b.fillStyle=
t;b.lineWidth=k.lineThickness;var C="solid",D;if(b.setLineDash){var B=O(k.nullDataLineDashType,k.lineThickness),C=k.lineDashType;D=O(C,k.lineThickness)}for(g=!1;p<n.length;p++)if(q=n[p].x.getTime?n[p].x.getTime():n[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!g)))if(null!==n[p].y&&n[p].y.length&&"number"===typeof n[p].y[0]&&"number"===typeof n[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(n[p].y[0]);r=a.axisY.convertValueToPixel(n[p].y[1]);
var E=k.dataPointIds[p];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:p,x1:q,y1:g,y2:r};s[s.length]={x:q,y:g};y[y.length]={x:q,y:r};p<n.length-1&&(A!==(n[p].lineColor||x)||C!==(n[p].lineDashType||k.lineDashType))&&(A=n[p].lineColor||x,s[s.length-1].newStrokeStyle=A,b.setLineDash&&(n[p].lineDashType?(C=n[p].lineDashType,s[s.length-1].newLineDashArray=O(C,k.lineThickness)):(C=k.lineDashType,s[s.length-1].newLineDashArray=D)));if(0!==n[p].markerSize&&(0<
n[p].markerSize||0<k.markerSize)){var F=k.getMarkerProperties(p,q,g,b);f.push(F);var K=Q(E);v&&f.push({x:q,y:g,ctx:e,type:F.type,size:F.size,color:K,borderColor:K,borderThickness:F.borderThickness});F=k.getMarkerProperties(p,q,r,b);f.push(F);K=Q(E);v&&f.push({x:q,y:r,ctx:e,type:F.type,size:F.size,color:K,borderColor:K,borderThickness:F.borderThickness})}if(n[p].indexLabel||k.indexLabel||n[p].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],
dataSeries:k,indexKeyword:0,point:{x:q,y:g},direction:n[p].y[0]<=n[p].y[1]?-1:1,color:t}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:1,point:{x:q,y:r},direction:n[p].y[0]<=n[p].y[1]?1:-1,color:t});g=!1}else 0<p&&!g&&(k.connectNullData?b.setLineDash&&(0<s.length&&(k.options.nullDataLineDashType||!n[p-1].lineDashType))&&(s[s.length-1].newLineDashArray=B,C=k.nullDataLineDashType):(d(D,x),s=[],y=[])),g=!0;d(D,x);W.drawMarkers(f)}}v&&(c.drawImage(this._preRenderCanvas,
...
e;s.fallingColor=s.options.fallingColor?s.options.fallingColor:"#e40a0a";var t="number"===typeof s.options.lineThickness?Math.round(s.lineThickness):1,x=1===Math.round(t)%2?-0.5:0;if(0<w.length)for(var A=5<q&&s.bevelEnabled?!0:!1,C=!1,y=null,B=null,l=0;l<w.length;l++)if(w[l].getTime?n=w[l].x.getTime():n=w[l].x,"number"!==typeof w[l].y){if(0<l&&!C&&s.connectNullData)var E=s.options.nullDataLineDashType||!w[l-1].lineDashType?s.nullDataLineDashType:w[l-1].lineDashType;C=!0}else{h=a.axisX.convertValueToPixel(n);
m=0===s.dataPointEOs[l].cumulativeSum?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSum);k=0===s.dataPointEOs[l].cumulativeSumYStartValue?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSumYStartValue);h=a.axisX.reversed?h+a.plotType.totalDataSeries*q/2-(a.previousDataSeriesCount+g)*q<<0:h-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+g)*q<<0;var F=a.axisX.reversed?h-q<<0:h+q<<0;m>k&&(e=m,m=k,k=e);a.axisY.reversed&&(e=m,m=k,k=e);e=s.dataPointIds[l];this._eventManager.objectMap[e]=
{id:e,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:l,x1:h,y1:m,x2:F,y2:k};var K=w[l].color?w[l].color:0<w[l].y?s.risingColor:s.fallingColor;ca(c,h,m,F,k,K,0,K,A,A,!1,!1,s.fillOpacity);e=Q(e);v&&ca(this._eventManager.ghostCtx,h,m,F,k,e,0,null,!1,!1,!1,!1);var aa,K=h;aa="undefined"!==typeof w[l].isIntermediateSum&&!0===w[l].isIntermediateSum||"undefined"!==typeof w[l].isCumulativeSum&&!0===w[l].isCumulativeSum?0<w[l].y?m:k:0<w[l].y?k:m;0<l&&y&&(!C||s.connectNullData)&&(C&&c.setLineDash&&
c.setLineDash(O(E,t)),c.beginPath(),c.moveTo(y,B-x),c.lineTo(K,aa-x),0<t&&c.stroke(),v&&(b.beginPath(),b.moveTo(y,B-x),b.lineTo(K,aa-x),0<t&&b.stroke()));C=!1;y=F;B=0<w[l].y?m:k;K=w[l].lineDashType?w[l].lineDashType:s.options.lineDashType?s.options.lineDashType:"shortDash";c.strokeStyle=w[l].lineColor?w[l].lineColor:s.options.lineColor?s.options.lineColor:"#9e9e9e";c.lineWidth=t;c.setLineDash&&(K=O(K,t),c.setLineDash(K));(w[l].indexLabel||s.indexLabel||w[l].indexLabelFormatter||s.indexLabelFormatter)&&
this._indexLabels.push({chartType:"waterfall",dataPoint:w[l],dataSeries:s,point:{x:h+(F-h)/2,y:0<=w[l].y?m:k},direction:0>w[l].y===a.axisY.reversed?1:-1,bounds:{x1:h,y1:Math.min(m,k),x2:F,y2:Math.max(m,k)},color:e})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&
this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,f.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};var Z=function(a,d,c,b,e,f,l,h,m){if(!(0>c)){"undefined"===typeof h&&(h=1);if(!v){var k=Number((l%(2*Math.PI)).toFixed(8));Number((f%(2*Math.PI)).toFixed(8))===k&&(l-=1E-4)}a.save();a.globalAlpha=h;"pie"===
e?(a.beginPath(),a.moveTo(d.x,d.y),a.arc(d.x,d.y,c,f,l,!1),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=2,a.closePath(),a.fill()):"doughnut"===e&&(a.beginPath(),a.arc(d.x,d.y,c,f,l,!1),0<=m&&a.arc(d.x,d.y,m*c,l,f,!0),a.closePath(),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=2,a.fill());a.globalAlpha=1;a.restore()}};m.prototype.renderPie=function(a){function d(){if(k&&n){for(var a=0,b=0,c=0,d=0,e=0;e<n.length;e++){var f=n[e],l=k.dataPointIds[e];g[e].id=l;g[e].objectType="dataPoint";g[e].dataPointIndex=
e;g[e].dataSeriesIndex=0;var p=g[e],h={percent:null,total:null},u=null,h=m.getPercentAndTotal(k,f);if(k.indexLabelFormatter||f.indexLabelFormatter)u={chart:m.options,dataSeries:k,dataPoint:f,total:h.total,percent:h.percent};h=f.indexLabelFormatter?f.indexLabelFormatter(u):f.indexLabel?m.replaceKeywordsWithValue(f.indexLabel,f,k,e):k.indexLabelFormatter?k.indexLabelFormatter(u):k.indexLabel?m.replaceKeywordsWithValue(k.indexLabel,f,k,e):f.label?f.label:"";m._eventManager.objectMap[l]=p;p.center={x:A.x,
y:A.y};p.y=f.y;p.radius=B;p.percentInnerRadius=F;p.indexLabelText=h;p.indexLabelPlacement=k.indexLabelPlacement;p.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:k.options.indexLabelLineColor?k.options.indexLabelLineColor:f.color?f.color:k._colorSet[e%k._colorSet.length];p.indexLabelLineThickness=s(f.indexLabelLineThickness)?k.indexLabelLineThickness:f.indexLabelLineThickness;p.indexLabelLineDashType=f.indexLabelLineDashType?f.indexLabelLineDashType:k.indexLabelLineDashType;p.indexLabelFontColor=
f.indexLabelFontColor?f.indexLabelFontColor:k.indexLabelFontColor;p.indexLabelFontStyle=f.indexLabelFontStyle?f.indexLabelFontStyle:k.indexLabelFontStyle;p.indexLabelFontWeight=f.indexLabelFontWeight?f.indexLabelFontWeight:k.indexLabelFontWeight;p.indexLabelFontSize=s(f.indexLabelFontSize)?k.indexLabelFontSize:f.indexLabelFontSize;p.indexLabelFontFamily=f.indexLabelFontFamily?f.indexLabelFontFamily:k.indexLabelFontFamily;p.indexLabelBackgroundColor=f.indexLabelBackgroundColor?f.indexLabelBackgroundColor:
k.options.indexLabelBackgroundColor?k.options.indexLabelBackgroundColor:k.indexLabelBackgroundColor;p.indexLabelMaxWidth=f.indexLabelMaxWidth?f.indexLabelMaxWidth:k.indexLabelMaxWidth?k.indexLabelMaxWidth:0.33*q.width;p.indexLabelWrap="undefined"!==typeof f.indexLabelWrap?f.indexLabelWrap:k.indexLabelWrap;p.startAngle=0===e?k.startAngle?k.startAngle/180*Math.PI:0:g[e-1].endAngle;p.startAngle=(p.startAngle+2*Math.PI)%(2*Math.PI);p.endAngle=p.startAngle+2*Math.PI/C*Math.abs(f.y);f=(p.endAngle+p.startAngle)/
2;f=(f+2*Math.PI)%(2*Math.PI);p.midAngle=f;if(p.midAngle>Math.PI/2-t&&p.midAngle<Math.PI/2+t){if(0===a||g[c].midAngle>p.midAngle)c=e;a++}else if(p.midAngle>3*Math.PI/2-t&&p.midAngle<3*Math.PI/2+t){if(0===b||g[d].midAngle>p.midAngle)d=e;b++}p.hemisphere=f>Math.PI/2&&f<=3*Math.PI/2?"left":"right";p.indexLabelTextBlock=new ia(m.plotArea.ctx,{fontSize:p.indexLabelFontSize,fontFamily:p.indexLabelFontFamily,fontColor:p.indexLabelFontColor,fontStyle:p.indexLabelFontStyle,fontWeight:p.indexLabelFontWeight,
horizontalAlign:"left",backgroundColor:p.indexLabelBackgroundColor,maxWidth:p.indexLabelMaxWidth,maxHeight:p.indexLabelWrap?5*p.indexLabelFontSize:1.5*p.indexLabelFontSize,text:p.indexLabelText,padding:0,textBaseline:"top"});p.indexLabelTextBlock.measureText()}l=f=0;h=!1;for(e=0;e<n.length;e++)p=g[(c+e)%n.length],1<a&&(p.midAngle>Math.PI/2-t&&p.midAngle<Math.PI/2+t)&&(f<=a/2&&!h?(p.hemisphere="right",f++):(p.hemisphere="left",h=!0));h=!1;for(e=0;e<n.length;e++)p=g[(d+e)%n.length],1<b&&(p.midAngle>
3*Math.PI/2-t&&p.midAngle<3*Math.PI/2+t)&&(l<=b/2&&!h?(p.hemisphere="left",l++):(p.hemisphere="right",h=!0))}}function c(a){var b=m.plotArea.ctx;b.clearRect(q.x1,q.y1,q.width,q.height);b.fillStyle=m.backgroundColor;b.fillRect(q.x1,q.y1,q.width,q.height);for(b=0;b<n.length;b++){var c=g[b].startAngle,d=g[b].endAngle;if(d>c){var e=0.07*B*Math.cos(g[b].midAngle),f=0.07*B*Math.sin(g[b].midAngle),l=!1;if(n[b].exploded){if(1E-9<Math.abs(g[b].center.x-(A.x+e))||1E-9<Math.abs(g[b].center.y-(A.y+f)))g[b].center.x=
A.x+e*a,g[b].center.y=A.y+f*a,l=!0}else if(0<Math.abs(g[b].center.x-A.x)||0<Math.abs(g[b].center.y-A.y))g[b].center.x=A.x+e*(1-a),g[b].center.y=A.y+f*(1-a),l=!0;l&&(e={},e.dataSeries=k,e.dataPoint=k.dataPoints[b],e.index=b,m.toolTip.highlightObjects([e]));Z(m.plotArea.ctx,g[b].center,g[b].radius,n[b].color?n[b].color:k._colorSet[b%k._colorSet.length],k.type,c,d,k.fillOpacity,g[b].percentInnerRadius)}}a=m.plotArea.ctx;a.save();a.fillStyle="black";a.strokeStyle="grey";a.textBaseline="middle";a.lineJoin=
...
q.y1,q.width,q.height);for(var b=g[0].startAngle+2*Math.PI*a,c=0;c<n.length;c++){var d=0===c?g[c].startAngle:e,e=d+(g[c].endAngle-g[c].startAngle),f=!1;e>b&&(e=b,f=!0);var l=n[c].color?n[c].color:k._colorSet[c%k._colorSet.length];e>d&&Z(m.plotArea.ctx,g[c].center,g[c].radius,l,k.type,d,e,k.fillOpacity,g[c].percentInnerRadius);if(f)break}h();m.dispatchEvent("dataAnimationIterationEnd",{chart:m});1<=a&&m.dispatchEvent("dataAnimationEnd",{chart:m})},function(){m.disableToolTip=!1;m._animator.animate(0,
...
p)),d.push(h);return d}function b(){if(t&&x){for(var a,b,c,d,e,f,k,l,n,h,p,q,u,m,r=[],z=[],w={percent:null,total:null},C=null,A=0;A<x.length;A++)m=P[A],m="undefined"!==typeof m.x5?(m.y2+m.y4)/2:(m.y2+m.y3)/2,m=g(m).x2+1,r[A]=N-m-U;m=0.5*U;for(var A=0,B=x.length-1;A<x.length||0<=B;A++,B--){b=t.reversed?x[B]:x[A];a=b.color?b.color:t.reversed?t._colorSet[(x.length-1-A)%t._colorSet.length]:t._colorSet[A%t._colorSet.length];c=b.indexLabelPlacement||t.indexLabelPlacement||"outside";d=b.indexLabelBackgroundColor||
...
t.indexLabelLineThickness:2;p=b.indexLabelLineDashType||t.indexLabelLineDashType||"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof t.indexLabelWrap?t.indexLabelWrap:!0;u=t.dataPointIds[A];y._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataPointIndex:A,dataSeriesIndex:0,funnelSection:P[t.reversed?x.length-1-A:A]};"inside"===t.indexLabelPlacement&&(r[A]=A!==ca?t.reversed?P[A].x2-P[A].x1:P[A].x3-P[A].x4:P[A].x3-P[A].x6,20>r[A]&&(r[A]=A!==ca?t.reversed?
P[A].x3-P[A].x4:P[A].x2-P[A].x1:P[A].x2-P[A].x1,r[A]/=2));u=b.indexLabelMaxWidth?b.indexLabelMaxWidth:t.options.indexLabelMaxWidth?t.indexLabelMaxWidth:r[A];if(u>r[A]||0>u)u=r[A];z[A]="inside"===t.indexLabelPlacement?P[A].height:!1;w=y.getPercentAndTotal(t,b);if(t.indexLabelFormatter||b.indexLabelFormatter)C={chart:y.options,dataSeries:t,dataPoint:b,total:w.total,percent:w.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(C):b.indexLabel?y.replaceKeywordsWithValue(b.indexLabel,b,t,A):t.indexLabelFormatter?
t.indexLabelFormatter(C):t.indexLabel?y.replaceKeywordsWithValue(t.indexLabel,b,t,A):b.label?b.label:"";0>=h&&(h=0);1E3>u&&1E3-u<m&&(u+=1E3-u);Q.roundRect||za(Q);c=new ia(Q,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:k,fontWeight:n,horizontalAlign:c,backgroundColor:d,maxWidth:u,maxHeight:!1===z[A]?q?4.28571429*f:1.5*f:z[A],text:b,padding:da});c.measureText();I.push({textBlock:c,id:t.reversed?B:A,isDirty:!1,lineColor:a,lineThickness:h,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,
width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=[];e=!1;c=0;for(var g,k=N-X-U/2,k=t.options.indexLabelMaxWidth?t.indexLabelMaxWidth>k?k:t.indexLabelMaxWidth:k,l=I.length-1;0<=l;l--){g=x[I[l].id];c=I[l];d=c.textBlock;b=(a=q(l)<P.length?I[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+da>b.y&&(e=!0);c=g.indexLabelMaxWidth||k;if(c>k||0>c)c=k;f.push(c)}if(e)for(l=I.length-1;0<=l;l--)a=P[l],I[l].textBlock.maxWidth=f[f.length-(l+1)],I[l].textBlock.measureText(),I[l].textBlock.x=
N-k,c=I[l].textBlock.height<I[l].textBlock.maxHeight?I[l].textBlock.height:I[l].textBlock.maxHeight,e=I[l].textBlock.width<I[l].textBlock.maxWidth?I[l].textBlock.width:I[l].textBlock.maxWidth,I[l].height=c,I[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,I[l].textBlock.y=c-I[l].height/2,t.reversed?(I[l].textBlock.y+I[l].height>S+C&&(I[l].textBlock.y=S+C-I[l].height),I[l].textBlock.y<qa-C&&(I[l].textBlock.y=qa-C)):(I[l].textBlock.y<S-C&&(I[l].textBlock.y=S-C),I[l].textBlock.y+I[l].height>
qa+C&&(I[l].textBlock.y=qa+C-I[l].height))}function f(){var a,b,c,d;if("inside"!==t.indexLabelPlacement)for(var e=0;e<P.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=P[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=t.reversed?"undefined"!==typeof a.x5?c>va?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<va?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,I[e].textBlock.x=b+U,I[e].textBlock.y=c-I[e].height/2,t.reversed?(I[e].textBlock.y+I[e].height>S+C&&(I[e].textBlock.y=
S+C-I[e].height),I[e].textBlock.y<qa-C&&(I[e].textBlock.y=qa-C)):(I[e].textBlock.y<S-C&&(I[e].textBlock.y=S-C),I[e].textBlock.y+I[e].height>qa+C&&(I[e].textBlock.y=qa+C-I[e].height)));else for(e=0;e<P.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=P[e],b=a.height,c=I[e].height,d=I[e].width,b>=c?(b=e!=ca?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=ca?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,I[e].textBlock.x=b,I[e].textBlock.y=c):I[e].isDirty=!0)}function l(){function a(b,c){var d;if(0>b||b>=I.length)return 0;
var e,f=I[b].textBlock;if(0>c){c*=-1;e=p(b);d=h(e,b);if(d>=c)return f.y-=c,c;if(0==b)return 0<d&&(f.y-=d),d;d+=a(e,-(c-d));0<d&&(f.y-=d);return d}e=q(b);d=h(b,e);if(d>=c)return f.y+=c,c;if(b==P.length-1)return 0<d&&(f.y+=d),d;d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,k;f=(R-Y+2*C)/n;k=n;for(var l,h=1;h<k;h++){e=h*f;for(var u=I.length-1;0<=u;u--)!I[u].isDirty&&(I[u].textBlock.y<e&&I[u].textBlock.y+I[u].height>e)&&(l=q(u),!(l>=I.length-1)&&I[u].textBlock.y+I[u].height+da>I[l].textBlock.y&&
(I[u].textBlock.y=I[u].textBlock.y+I[u].height-e>e-I[u].textBlock.y?e+1:e-I[u].height-1))}for(l=P.length-1;0<l;l--)if(!I[l].isDirty){e=p(l);if(0>e&&(e=0,I[e].isDirty))break;if(I[l].textBlock.y<I[e].textBlock.y+I[e].height){d=d||l;f=l;for(k=0;I[f].textBlock.y<I[e].textBlock.y+I[e].height+da;){a=a||I[f].textBlock.y+I[f].height;k+=I[f].height;k+=da;f=e;if(0>=f){f=0;k+=I[f].height;break}e=p(f);if(0>e){f=0;k+=I[f].height;break}}if(f!=l){g=I[f].textBlock.y;a-=g;a=k-a;g=c(a,d,f);break}}}return g}function c(a,
b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=b;d++)e.push(P[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=e[d],f<a)g++,f+=I[b.id].height+da,I[b.id].textBlock.text="",I[b.id].indexLabelText="",I[b.id].isDirty=!0,I[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,k,l,n=1,m=0;m<2*n;m++){for(var r=I.length-1;0<=r&&!(0<=p(r)&&p(r),f=I[r],g=f.textBlock,l=(k=q(r)<P.length?I[q(r)]:null)?k.textBlock:null,d=+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&
(k&&e+d+da>+l.y.toFixed(6))&&(d=g.y+d+da-l.y,e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function h(a,b){return(b<P.length?I[b].textBlock.y:t.reversed?S+C:qa+C)-(0>a?t.reversed?qa-C:S-C:I[a].textBlock.y+I[a].height+da)}function m(a,b,c){var d,e,g,l=[],h=C,p=[];-1!==b&&(0<=Z.indexOf(b)?(e=Z.indexOf(b),Z.splice(e,1)):(Z.push(b),Z=Z.sort(function(a,b){return a-b})));if(0===Z.length)l=ga;else{e=C*(1!=Z.length||0!=Z[0]&&Z[0]!=P.length-1?2:1)/k();for(var q=0;q<P.length;q++){if(1==Z.length&&
0==Z[0]){if(0===q){l.push(ga[q]);d=h;continue}}else 0===q&&(d=-1*h);l.push(ga[q]+d);if(0<=Z.indexOf(q)||q<P.length&&0<=Z.indexOf(q+1))d+=e}}g=function(){for(var a=[],b=0;b<P.length;b++)a.push(l[b]-P[b].y1);return a}();var u={startTime:(new Date).getTime(),duration:c||500,easingFunction:function(a,b,c,d){return L.easing.easeOutQuart(a,b,c,d)},changeSection:function(a){for(var b,c,d=0;d<P.length;d++)b=g[d],c=P[d],b*=a,"undefined"===typeof p[d]&&(p[d]=0),0>p&&(p*=-1),c.y1+=b-p[d],c.y2+=b-p[d],c.y3+=
b-p[d],c.y4+=b-p[d],c.y5&&(c.y5+=b-p[d],c.y6+=b-p[d]),p[d]=b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;ha=!0;d.clearRect(A.x1,A.y1,A.x2-A.x1,A.y2-A.y1);d.fillStyle=a.backgroundColor;d.fillRect(A.x1,A.y1,A.width,A.height);u.changeSection(c,b);var e={};e.dataSeries=t;e.dataPoint=t.reversed?t.dataPoints[x.length-1-b]:t.dataPoints[b];e.index=t.reversed?x.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<P.length;e++)oa(d,P[e],t.fillOpacity);w(d);K&&("inside"!==t.indexLabelPlacement?
n(d):f(),r(d));1<=c&&(ha=!1)},null,L.easing.easeOutQuart)}function k(){for(var a=0,b=0;b<P.length-1;b++)(0<=Z.indexOf(b)||0<=Z.indexOf(b+1))&&a++;return a}function n(a){for(var b,c,d,e,f=0;f<P.length;f++)e=1===I[f].lineThickness%2?0.5:0,c=((P[f].y2+P[f].y4)/2<<0)+e,b=g(c).x2-1,d=I[f].textBlock.x,e=(I[f].textBlock.y+I[f].height/2<<0)+e,I[f].isDirty||0==I[f].lineThickness||(a.strokeStyle=I[f].lineColor,a.lineWidth=I[f].lineThickness,a.setLineDash&&a.setLineDash(O(I[f].lineDashType,I[f].lineThickness)),
a.beginPath(),a.moveTo(b,c),a.lineTo(d,e),a.stroke())}function p(a){for(a-=1;-1<=a&&-1!=a&&I[a].isDirty;a--);return a}function q(a){for(a+=1;a<=P.length&&a!=P.length&&I[a].isDirty;a++);return a}function g(a){for(var b,c=0;c<x.length;c++)if(P[c].y1<a&&P[c].y4>a){b=P[c];break}return b?(a=b.y6?a>b.y6?b.x3+(b.x4-b.x3)/(b.y4-b.y3)*(a-b.y3):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2),{x1:a,x2:a}):-1}function r(a){for(var b=0;b<P.length;b++)I[b].isDirty||(a&&(I[b].textBlock.ctx=
a),I[b].textBlock.render(!0))}function w(a){y.plotArea.layoutManager.reset();a.roundRect||za(a);y.title&&(y.title.dockInsidePlotArea||"center"===y.title.horizontalAlign&&"center"===y.title.verticalAlign)&&(y.title.ctx=a,y.title.render());if(y.subtitles)for(var b=0;b<y.subtitles.length;b++){var c=y.subtitles[b];if(c.dockInsidePlotArea||"center"===c.horizontalAlign&&"center"===c.verticalAlign)y.subtitles.ctx=a,c.render()}y.legend&&(y.legend.dockInsidePlotArea||"center"===y.legend.horizontalAlign&&"center"===
y.legend.verticalAlign)&&(y.legend.ctx=a,y.legend.setLayout(),y.legend.render());J.fNg&&J.fNg(y)}var y=this;if(!(0>=a.dataSeriesIndexes.length)){for(var t=this.data[a.dataSeriesIndexes[0]],x=t.dataPoints,A=this.plotArea,C=0.025*A.width,D=0.01*A.width,B=0,E=A.height-2*C,F=Math.min(A.width-2*D,2.8*A.height),K=!1,H=0;H<x.length;H++)if(!K&&("undefined"!==typeof x[H].indexLabel&&null!==x[H].indexLabel&&0<x[H].indexLabel.toString().length)&&(K=!0),!K&&("undefined"!==typeof x[H].label&&null!==x[H].label&&
0<x[H].label.toString().length)&&(K=!0),!K&&"function"===typeof t.indexLabelFormatter||"function"===typeof x[H].indexLabelFormatter)K=!0;K=K||"undefined"!==typeof t.indexLabel&&null!==t.indexLabel&&0<t.indexLabel.toString().length;"inside"!==t.indexLabelPlacement&&K||(D=(A.width-0.75*F)/2);var H=A.x1+D,N=A.x2-D,Y=A.y1+C,R=A.y2-C,Q=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=t.length&&(t.dataPoints&&t.visible)&&0!==x.length){var ba,G;a=75*F/100;var U=30*(N-a)/100;"funnel"===t.type?(ba=s(t.options.neckHeight)?
0.35*E:t.neckHeight,G=s(t.options.neckWidth)?0.25*a:t.neckWidth,"string"===typeof ba&&ba.match(/%$/)?(ba=parseInt(ba),ba=ba*E/100):ba=parseInt(ba),"string"===typeof G&&G.match(/%$/)?(G=parseInt(G),G=G*a/100):G=parseInt(G),ba>E?ba=E:0>=ba&&(ba=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===t.type&&(G=ba=0,t.reversed=t.reversed?!1:!0);var D=H+a/2,V=H,X=H+a,S=t.reversed?R:Y,M=D-G/2,W=D+G/2,va=t.reversed?Y+ba:R-ba,qa=t.reversed?Y:R;a=[];var D=[],P=[],F=[],T=Y,ca,$=(va-S)/(M-V),ea=-$,H="area"===(t.valueRepresents?
t.valueRepresents:"height")?c():d();if(-1!==H){if(t.reversed)for(F.push(T),G=H.length-1;0<G;G--)T+=H[G],F.push(T);else for(G=0;G<H.length;G++)T+=H[G],F.push(T);if(t.reversed)for(G=0;G<H.length;G++)F[G]<va?(a.push(M),D.push(W),ca=G):(a.push((F[G]-S+$*V)/$),D.push((F[G]-S+ea*X)/ea));else for(G=0;G<H.length;G++)F[G]<va?(a.push((F[G]-S+$*V)/$),D.push((F[G]-S+ea*X)/ea),ca=G):(a.push(M),D.push(W));for(G=0;G<H.length-1;G++)T=t.reversed?x[x.length-1-G].color?x[x.length-1-G].color:t._colorSet[(x.length-1-
G)%t._colorSet.length]:x[G].color?x[G].color:t._colorSet[G%t._colorSet.length],G===ca?P.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:W,y3:va,x4:D[G+1],y4:F[G+1],x5:a[G+1],y5:F[G+1],x6:M,y6:va,id:G,height:F[G+1]-F[G],color:T}):P.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:D[G+1],y3:F[G+1],x4:a[G+1],y4:F[G+1],id:G,height:F[G+1]-F[G],color:T});var da=2,I=[],ha=!1,Z=[],ga=[],H=!1;a=a=0;Aa(Z);for(G=0;G<x.length;G++)x[G].exploded&&(H=!0,t.reversed?Z.push(x.length-1-G):Z.push(G));Q.clearRect(A.x1,A.y1,A.width,
A.height);Q.fillStyle=y.backgroundColor;Q.fillRect(A.x1,A.y1,A.width,A.height);if(K&&t.visible&&(b(),f(),e(),"inside"!==t.indexLabelPlacement)){l();for(G=0;G<x.length;G++)I[G].isDirty||(a=I[G].textBlock.x+I[G].width,a=(N-a)/2,0==G&&(B=a),B>a&&(B=a));for(G=0;G<P.length;G++)P[G].x1+=B,P[G].x2+=B,P[G].x3+=B,P[G].x4+=B,P[G].x5&&(P[G].x5+=B,P[G].x6+=B),I[G].textBlock.x+=B}for(G=0;G<P.length;G++)B=P[G],oa(Q,B,t.fillOpacity),ga.push(B.y1);w(Q);K&&t.visible&&("inside"===t.indexLabelPlacement||y.animationEnabled||
n(Q),y.animationEnabled||r());if(!K)for(G=0;G<x.length;G++)B=t.dataPointIds[G],a={id:B,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:P[t.reversed?x.length-1-G:G]},y._eventManager.objectMap[B]=a;!y.animationEnabled&&H?m(y,-1,0):y.animationEnabled&&!y.animatedRender&&m(y,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ha&&!y.isAnimating&&(s(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=t.reversed?x.length-1-a.dataPointIndex:a.dataPointIndex,0<=
b)){a=b;if("funnel"===t.type||"pyramid"===t.type)t.reversed?x[x.length-1-a].exploded=x[x.length-1-a].exploded?!1:!0:x[a].exploded=x[a].exploded?!1:!0;m(y,b,500)}};return{source:Q,dest:this.plotArea.ctx,animationCallback:function(a,b){L.fadeInAnimation(a,b);1<=a&&(m(y,-1,500),w(y.plotArea.ctx||y.ctx))},easingFunction:L.easing.easeInQuad,animationBase:0}}}}};m.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||
...
function(a){a="undefined"===typeof a?{}:a;var d=a.format?a.format:"png",c=a.fileName?a.fileName:this.exportFileName;if(a.toDataURL)return this.canvas.toDataURL("image/"+d);var b=this.canvas;if(b&&d&&c){c=c+"."+d;a="image/"+d;var b=b.toDataURL(a),e=!1,f=document.createElement("a");f.download=c;f.href=b;if("undefined"!==typeof Blob&&new Blob){for(var l=b.replace(/^data:[a-z\/]*;base64,/,""),l=atob(l),h=new ArrayBuffer(l.length),h=new Uint8Array(h),m=0;m<l.length;m++)h[m]=l.charCodeAt(m);d=new Blob([h.buffer],
...
f._cultureInfo);else return"y"===a?ea(g,d.yValueFormatString?d.yValueFormatString:c.yValueFormatString?c.yValueFormatString:c.yValueFormatString="#,##0.########",f._cultureInfo):"z"===a?ea(g,d.zValueFormatString?d.zValueFormatString:c.zValueFormatString?c.zValueFormatString:c.zValueFormatString="#,##0.########",f._cultureInfo):g})};ma(F,V);F.prototype.setLayout=function(){var a=this.dockInsidePlotArea?this.chart.plotArea:this.chart,d=a.layoutManager.getFreeSpace(),c=null,b=0,e=0,f=0,l=0,h=this.markerMargin=
...
dataPointIndex:null,markerBorderColor:w,markerBorderThickness:t};m.push(q)}else for(var x=0;x<p.dataPoints.length;x++){var A=p.dataPoints[x],q=A.legendMarkerType?A.legendMarkerType:p.legendMarkerType?p.legendMarkerType:H.getDefaultLegendMarker(p.type),g=A.legendText?A.legendText:p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:A}):A.name?A.name:"DataPoint: "+(x+1),r=A.legendMarkerColor?A.legendMarkerColor:p.legendMarkerColor?
p.legendMarkerColor:A.color?A.color:p.color?p.color:p._colorSet[x%p._colorSet.length],v=0.75*this.lineHeight,w=A.legendMarkerBorderColor?A.legendMarkerBorderColor:p.legendMarkerBorderColor?p.legendMarkerBorderColor:A.markerBorderColor?A.markerBorderColor:p.markerBorderColor,t=A.legendMarkerBorderThickness?A.legendMarkerBorderThickness:p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:A.markerBorderThickness||p.markerBorderThickness?Math.max(1,Math.round(0.2*v)):0,g=this.chart.replaceKeywordsWithValue(g,
A,p,x),q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:v,dataSeriesIndex:n,dataPointIndex:x,markerBorderColor:w,markerBorderThickness:t};(A.showInLegend||p.showInLegend&&!1!==A.showInLegend)&&m.push(q)}}!0===this.reversed&&m.reverse();if(0<m.length){p=null;r=g=A=x=0;A=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,f):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,f):this.itemMaxWidth=
...
2}h+=n}};ma(H,V);H.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===a||"stackedLine"===a||"bubble"===a||"scatter"===a||"stackedArea"===a||"stackedColumn100"===a||"stackedLine100"===a||"stackedArea100"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===a||"rangeArea"===a||"rangeSplineArea"===a||"boxAndWhisker"===a||"waterfall"===a)return"normal";if("bar"===a||"stackedBar"===
...
0<a.getSeconds()||0<a.getMilliseconds())a.setMonth(a.getMonth()+1),a.setDate(1),a.setHours(0),a.setMinutes(0),a.setSeconds(0),a.setMilliseconds(0)}else"year"===this.intervalType&&(0<a.getMonth()||1<a.getDate()||0<a.getHours()||0<a.getMinutes()||0<a.getSeconds()||0<a.getMilliseconds())&&(a.setFullYear(a.getFullYear()+1),a.setMonth(0),a.setDate(1),a.setHours(0),a.setMinutes(0),a.setSeconds(0),a.setMilliseconds(0));return a};ma(S,V);ma(T,V);T.prototype.createUserOptions=function(a){if("undefined"!==
...
0,r=w=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,w=r);else y+=n[r].dataPoint.y,t=Math.abs(a-this.parent.convertValueToPixel(y)),t<v&&(v=t,w=r);else if("stackedBar100"===n[0].dataSeries.type)for(var v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),C=y=t=0,r=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=
Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,w=r);else y+=n[r].dataPoint.y,C=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,C=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[C]),t=Math.abs(a-this.parent.convertValueToPixel(C)),t<v&&(v=t,w=r);else for(v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=w=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),
...
C=y=t=0;for(r=w;0<=r;r--)y+=n[r].dataPoint.y,C=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,C=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[C]),t=Math.abs(a-this.parent.convertValueToPixel(C)),t<v&&(v=t,b=r);h=1===q.lineWidth%2?(this.parent.convertValueToPixel(C)<<0)+0.5:this.parent.convertValueToPixel(C)<<0;this.value=C;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:C}):s(this.options.label)?ea(c?
c:C,this.valueFormatString,this.chart._cultureInfo):this.label}else h=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y)<<0,this.value=x.dataPoint.y,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y}):s(this.options.label)?ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=h;f=this.chart.plotArea.y1;l=this.chart.plotArea.y2;
...
n[r].dataPoint.y.length;x++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,w=r);else y+=n[r].dataPoint.y,t=Math.abs(d-this.parent.convertValueToPixel(y)),t<v&&(v=t,w=r);else if("stackedColumn100"===n[0].dataSeries.type||"stackedArea100"===n[0].dataSeries.type)for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=C=y=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),
t<v&&(v=t,w=r);else y+=n[r].dataPoint.y,C=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,C=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[C]),t=Math.abs(d-this.parent.convertValueToPixel(C)),t<v&&(v=t,w=r);else for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,w=r);else t=Math.abs(d-
...
ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=y}else if("stackedColumn100"===this.parent.dataSeries[w].type||"stackedArea100"===this.parent.dataSeries[w].type){v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));y=t=0;for(r=w;0<=r;r--)y+=n[r].dataPoint.y,C=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,C=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[C]),t=Math.abs(d-this.parent.convertValueToPixel(C)),t<v&&(v=t,b=r);m=
...
this.bounds={x1:b,y1:f-p/2,x2:e,y2:l+p/2};if("xySwapped"===this.chart.plotInfo.axisPlacement)if("left"===this.parent._position||"right"===this.parent._position){C=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),v=null,w=0;w<this.parent.dataSeries.length;w++)(v=this.parent.dataSeries[w].getDataPointAtX(r,!0))&&0<=v.index&&
...
this.valueFormatString,this.chart._cultureInfo):this.label,k.x=b-k.measureText().width/2,k.x+k.width>this.chart.bounds.x2&&(k.x=this.chart.bounds.x2-k.width),k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1),"bottom"===this.parent._position?k.y=this.parent.lineCoordinates.y2+k.fontSize/2+2:"top"===this.parent._position&&(k.y=this.parent.lineCoordinates.y1-k.height+k.fontSize/2+2)}else if("bottom"===this.parent._position||"top"===this.parent._position){C=!1;n="";if(this.parent.labels)for(n=Math.ceil(this.parent.interval),
...
"top"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(h);if("left"===this.parent._position||"right"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(m);q.globalAlpha=g};ma(X,V);X.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position="absolute";this.container.style.height=
